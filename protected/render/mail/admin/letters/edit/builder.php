...
<!--[if IE 9 ]><html class="ie9"><![endif]-->
    ...
    <body data-ma-header="teal">
        ...
        <div id="wrapper">
            ...
            <div id="tosave" data-id="11111111111111"  data-paramone="11" data-paramtwo="22" data-paramthree="33"><?= $data['letter']['html_source'] ?></div>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $('#edit-letter').submit(function(event) {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '<?= APP::Module('Routing')->root ?>admin/mail/api/letters/update/builder.json',
                        data: $(this).serialize(),
