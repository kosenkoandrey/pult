...
<!--[if IE 9 ]><html class="ie9"><![endif]-->
    <head>
        ...
        <title>Редактировать шорт-код</title>
    ...
    <body data-ma-header="teal">
        ...
        APP::Render('admin/widgets/header', 'include', [
            ...
            'Редактировать шорт-код' => 'admin/mail/shortcodes/edit/'.APP::Module('Routing')->get['shortcode_id_hash'],
        ]);
        ?>
        <section id="main">
                        ...
                        success: function(result) {
                            switch(result.status) {
                                case 'success':
                                    swal({
                                        title: 'Готово!',
                                        text: 'Шорт-код "' + code.val() + '" был обвновлен',
                                        type: 'success',
