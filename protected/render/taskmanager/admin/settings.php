                        ...
                        <form id="update-settings" class="form-horizontal" role="form">
                            ...
                            <div class="card-body card-padding">
                                <div class="form-group">
                                    <label for="module_taskmanager_db_connection" class="col-sm-2 control-label">Соединение с БД</label>
                                    <div class="col-sm-2">
                                        <div class="fg-line">
                                ...
                                <div class="form-group">
                                    <label for="module_taskmanager_complete_lifetime" class="col-sm-2 control-label">Время жизни исполненых задач</label>
                                    <div class="col-sm-2">
                                        <div class="fg-line">
                                ...
                                <div class="form-group">
                                    <label for="module_taskmanager_max_execution_time" class="col-sm-2 control-label">Максимальное время выполнения (сек)</label>
                                    <div class="col-sm-1">
                                        <div class="fg-line">
                                ...
                                <div class="form-group">
                                    <label for="module_taskmanager_memory_limit" class="col-sm-2 control-label">Лимит памяти</label>
                                    <div class="col-sm-1">
                                        <div class="fg-line">
                                ...
                                <div class="form-group">
                                    <label for="module_taskmanager_tmp_dir" class="col-sm-2 control-label">Временный каталог</label>
                                    <div class="col-sm-2">
                                        <div class="fg-line">
