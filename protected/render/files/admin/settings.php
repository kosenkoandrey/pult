                                ...
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane active animated fadeIn in" id="settings-main">
                                        <div class="form-group">
                                            <label for="module_files_db_connection" class="col-sm-2 control-label">Соединение с БД</label>
                                            <div class="col-sm-2">
                                                <div class="fg-line">
                                        ...
                                        <div class="form-group">
                                            <label for="module_files_path" class="col-sm-2 control-label">Путь к хранилищу</label>
                                            <div class="col-sm-10">
                                                <div class="fg-line">
                                        ...
                                        <div class="form-group">
                                            <label for="module_files_mime" class="col-sm-2 control-label">Разрешенные mime-типы</label>
                                            <div class="col-sm-6">
                                                <div class="fg-line">
                        ...
                        success: function(result) {
                            switch(result.status) {
                                case 'success':
                                    swal({
                                        title: 'Готово',
                                        text: 'Настройки файлов были успешно обновлены',
                                        type: 'success',
