...
<!--[if IE 9 ]><html class="ie9"><![endif]-->
    <head>
        ...
        <title>Проверка MP4 файла</title>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#add-file').submit(function(event) {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '<?= APP::Module('Routing')->root ?>admin/files/api/file/check/mp4.json',
                        data: data,
                        processData: false,
                        contentType: false,
                        success: function(result) {
                            switch(result.status) {
                                case 'success':
                                    swal({
                                        title: 'Готово',
                                        text: result.email ? 'Файл скачал "' + result.email + '"' : 'E-Mail определить не удалось',
                                        type: 'success',
                                        showCancelButton: false,
                                        confirmButtonText: 'Ok',
                                        closeOnConfirm: false
