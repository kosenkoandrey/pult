...
<!--[if IE 9 ]><html class="ie9"><![endif]-->
    ...
    <body data-ma-header="teal">
        <? APP::Render('admin/widgets/header', 'include', [
            $data['file']['basename'] => 'admin/files/preview' . APP::Module('Routing')->get['file_id_hash']
        ]) ?>
                ...
                <div class="container">
                    <div class="card">
                        <div class="card-body card-padding">
                            ...
                            ?>
                            <hr>
                            <a class="btn btn-lg palette-Teal bg waves-effect" target="_blank" href="<?= APP::Module('Routing')->root ?>files/download/<?= APP::Module('Crypt')->Encode($data['file']['id']) ?>" target="_blank"><i class="zmdi zmdi-download"></i> Скачать</a>
                        </div>
                    </div>
                    
                    <div class="card">
                        <div class="card-header">
                            <h2>Код для вставки в мемберку</h2>
                        </div>
                        <div class="card-body card-padding">
