                            ...
                            <ul class="actions">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li><a href="<?= APP::Module('Routing')->root ?>admin/members/pages/<?= $data['group_sub_id'] ? APP::Module('Crypt')->Encode($data['group_sub_id']) : 0 ?>/add">Добавить страницу</a></li>
                                        <li><a href="<?= APP::Module('Routing')->root ?>admin/members/pages/<?= $data['group_sub_id'] ? APP::Module('Crypt')->Encode($data['group_sub_id']) : 0 ?>/groups/add">Добавить группу</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
                            ...
                            if (count($data['list'])) {
                                        ...
                                        foreach ($data['list'] as $item) {
                                            switch ($item[0]) {
                                                case 'group':
                                                    ...
                                                    <tr>
                                                        <td class="group-name">
                                                            <span style="display: inline-block" class="avatar-char palette-Teal bg m-r-5">
                                                                <i class="zmdi zmdi-folder"></i>
                                                                <span class="badge group_id"><?= $item[1] ?></span>
                                                            </span> 
                                                            <a style="color: #4C4C4C" href="<?= APP::Module('Routing')->root ?>admin/members/pages/<?= APP::Module('Crypt')->Encode($item[1]) ?>"><?= $item[2] ?></a>
                                                        </td>
                                                        <td>
                                                ...
                                                case 'page':
                                                    ...
                                                    <tr>
                                                        <td class="page-name">
                                                            <span style="display: inline-block" class="avatar-char palette-Orange-400 bg m-r-5">
                                                                <i class="zmdi zmdi-file"></i>
                                                                <span class="badge page_id"><?= $item[1] ?></span>
                                                            </span> 
                                                            <a style="color: #4C4C4C" href="<?= APP::Module('Routing')->root ?>admin/members/page/<?= APP::Module('Crypt')->Encode($item[1]) ?>" target="_blank"><?= $item[2] ?></a>
                                                        </td>
                                                        <td>
                                ...
                                <div class="card-body card-padding">
                                    <div class="alert alert-warning" role="alert"><i class="zmdi zmdi-close-circle"></i> Страницы не найдены</div>
                                </div>
                                <?
                            }
                            ?>
