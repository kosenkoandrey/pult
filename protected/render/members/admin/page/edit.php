                    ...
                    <div class="card">
                        <form id="edit-page" class="form-horizontal" role="form">
                            ...
                            <div class="card-body card-padding">
                                ...
                                <div class="form-group">
                                    <label for="html" class="col-sm-2 control-label">HTML код</label>
                                    <div class="col-sm-10">
                                        <div class="fg-line">
                        ...
                        success: function(result) {
                            switch(result.status) {
                                case 'success':
                                    swal({
                                        title: 'Готово',
                                        text: 'Страница "' + title.val() + '" успешно обновлена',
                                        type: 'success',
                                        showCancelButton: false,
                                        confirmButtonText: 'Ok',
                                        closeOnConfirm: false
                            ...
                            $('#edit-page').find('[type="submit"]').html('Сохранить изменения').attr('disabled', false);
                        }
                    });
                  });
            });
