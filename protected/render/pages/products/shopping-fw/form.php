...
<link rel="stylesheet" href="<?= APP::Module('Routing')->root ?>public/modules/pages/products/shopping-fw/form/style_form.css">
                            ...
                            $.ajax({
                                ...
                                success: function(data) {
                                    $.ajax({
                                        ...
                                        success: function(data) {
                                            window.top.location.href = "<?= APP::Module('Routing')->root ?>products/shopping-fw/activate";
                                        }
                                    });
                                }
                            });
  ...
  <div class="wrap">
    <div class="optin animated fadeInDown">
      <div class="inner-wrap">
        <h2 ql-id="sales_pitch" ql-name="Sales Pitch" ql-editable="text">Запишитесь в предварительный список, чтобы получить скидку на Имидж-Практику<br>
"Шоппинг осень-зима под контролем стилиста".</h2>
