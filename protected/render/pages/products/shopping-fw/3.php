...
<div class="block17">
  ...
  <div class="block15" id="point01">
		<div class="ins">
          <div style="height:730px;">
            </div>
            <p style="margin:15px 70px 0px 70px; font-size:18px;">После того как вы пройдете имидж-практику "Шоппинг осень-зима под контролем стилиста" перед вами встанет проблема — "Где брать качественные и брендовые вещи, при этом не переплачивая за них?"</p><br>
          <p style="margin:0px 70px 0px 70px; font-size:18px;">Я сейчас сама активно исследую этот вопрос и с удовольствием поделюсь с вами наработками.</p><br>
          <p style="margin:0px 70px 0px 70px; font-size:18px;">Это отдельный курс, который поможет вам покупать одежду известных брендов со скидкой до 90%.</p><br>
          <p style="margin:0px 70px 0px 70px; font-size:18px;">В нем я расскажу:<br>
- о специальных интернет-площадках, где можно осуществлять покупку мировых брендов по выгодным ценам;<br>
- о тонкостях доставки в Россию, Европу и страны СНГ;<br>
- о секретных "фишках", которые позволят вам экономить и быть уверенной в качестве товара.</p><br>
	      <p style="margin:0px 70px 0px 70px; font-size:18px;">Пять важных нюансов, которые следует учесть:</p><br>
          <p style="margin:0px 70px 0px 70px; font-size:18px;">1) Заказывать одежду будем в Штатах. Соответственно, бренды будут, в основном, заатлантические (то есть Chanel со скидкой вы там не найдете ;)</p><br>
          <p style="margin:0px 70px 0px 70px; font-size:18px;">2) За счет чего такие скидки? Эти товары — нераспроданные остатки из коллекций. И чтобы продать их, производители предлагают хорошие скидки, а нередко и вовсе отдают товар по себестоимости.</p><br>
          <p style="margin:0px 70px 0px 70px; font-size:18px;">3) Вам не нужно беспокоиться о качестве этой одежды. Это действительно оригинальные вещи хорошего качества.</p><br>
          <p style="margin:0px 70px 0px 70px; font-size:18px;">4) Однако это не вещи из новых коллекций. Но при грамотном подходе и использовании правил, о которых я расскажу на имидж-практике, вы сможете собрать из них отличный базовый гардероб без переплат.</p><br>
          <p style="margin:0px 70px 15px 70px; font-size:18px;">5) Вещи, которые вы найдете, не обязательно будут со скидкой 90%. Чаще всего это скидка в 50%, но случаются и приятные исключения.</p>
	  </div>
	</div>
    
    <div class="block15-2">    
              <section style="padding: 50px 70px;" class="page">
              <div class="txt1"><span>Бонус для быстрых</span></div>
        <p style="color: #fff; font-size: 20px; font-family: 'Roboto Light', arial; line-height: 24px;">Стандартная цена курса "Как покупать брендовые вещи со скидкой до 90%" - 4900 рублей. Но вы можете получить его бесплатно. Для этого успейте заказать имидж-практику "Шоппинг осень-зима под контролем стилиста" в числе первых 100 клиентов.</p>
    
        <img src="<?= APP::Module('Routing')->root ?>public/modules/pages/products/shopping-fw/images/bns1-2.png" style="position: absolute; top: 250px; left: 90px; z-index: 5;">
        ...
        <div style="display: block; width: 440px; height: 70px; position: absolute; top: 350px; right: 200px; border: 2px solid #fff; z-index: 2;">
           <p style="color: #fff; font-size: 35px; text-align: center; line-height: 70px; font-family: 'Roboto Light', arial;">Цена: <span style=""><strike>4900 руб.</strike></span></p>
        </div>
    </section>
</div>      
...
- узнаете, как с помощью тенденций "разбавить" имеющийся гардероб, сделав его более модным и актуальным.</p> 	
     ...
     <div class="block15-2">    
        ...
        <p style="color: #fff; font-size: 20px; font-family: 'Roboto Light', arial; line-height: 24px;">Стандартная цена семинара "Тенденции сезона осень-зима 2017/2018 и как их применить для вашего гардероба" - 1000 рублей. Вы получаете его бонусом при покупке имидж-практики "Шоппинг осень-зима под контролем стилиста".</p>
...
<div class="block155">
		<div class="ins">
		  ...
		  <p style="margin:15px 70px 0px 70px; font-size:18px;">На этом семинаре:<br><br>
- вы узнаете TOP-10 цветов сезона осень-зима 2017/2018;<br><br>
- мы подробно разберем их на примерах коллекций этого сезона;<br><br>
- вы узнаете, с какими цветами они сочетаются;<br><br>
- вы сможете выбрать из них те, что подходят именно вам;<br><br>
- вы узнаете, как с их помощью сделать свой осенне-зимний гардероб более актуальным, стильным и "вкусным" с точки зрения цветовых решений;<br><br>
...
- какие цветовые решения будут выигрышными именно для вас.</p> 	
	...
	<div class="block18" id="point6">
		<div class="ins">
			<div class="bl_name">А хотите еще скидку в 50%?!</div>
			<div class="txt1">Я объявляю акцию на имидж-практику "Шоппинг осень-зима под контролем стилиста"! Но всего на несколько дней!</div>
			<div class="txt1">Если стандартная цена имидж-практики составляет 9 900 рублей, то вы сможете получить её со скидкой до 50%.</div>
<?
if (APP::Module('DB')->Select(
    ...
    ?>
    <div align="center" class="bl1"><b>Вы уже в списке на получение скидки</b></div>
    <?
} else { 
    ?>
    
                        <div class="txt2">Чтобы не пропустить эту возможность, <br> запишитесь в предварительный список ниже:</div>
            <iframe style="border:0px; border-width:0px;" width="100%" height="620px" align="middle" src="<?= APP::Module('Routing')->root ?>products/shopping-fw/form?email=<?= $user_email ?>&user_tunnel_id=<?= $data['id'] ?>&user_id=<?=$data['user_id']?>"></iframe>
...
?>
            <!--
			<div class="item i1">
				<div class="name">Пакет - STANDART</div>
				<div class="bl1">
				...
				<div class="bl2">
					<div class="pic"><img src="./images/gift3.png" alt=""/></div>
					<div class="price">3 999 руб</div>
					<a href="#">ЗАПИСАТЬСЯ</a>
				</div>
			</div>
			<div class="item i2">
				<div class="name">Пакет - GOLD</div>
				<div class="bl1">
					<span>В комплект входит:</span>
					<ul>
						<li>Lorem ipsum dolor sit amet, consectetur adipiscing elit. </li>
			...
			<div class="item i3">
				<div class="name">Пакет - PLATINUM</div>
				<div class="bl1">
					<span>В комплект входит:</span>
					<ul>
						<li>Lorem ipsum dolor sit amet, consectetur adipiscing elit. </li>
	...
	<!--
	<div class="block19">
		<div class="bl_name">FAQ</div>
		<div class="ins">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr class="tr1">
					<td class="td1"><img src="./images/q.png" alt=""/></td>
					<td class="td2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla ut tincidunt nisi, sed venenatis orci. In rhoncus mollis ante, eget dictum velit aliquam vitae. Quisque turpis lacus, convallis finibus ipsum vitae, facilisis commodo lacus. Ut imperdiet est vitae ex luctus molestie?</td>
				</tr>
				<tr class="tr2">
					<td class="td1"><img src="./images/a.png" alt=""/></td>
					<td class="td2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla ut tincidunt nisi, sed venenatis orci. In rhoncus mollis ante, eget dictum velit aliquam vitae. Quisque turpis lacus, convallis finibus ipsum vitae, facilisis commodo lacus. Ut imperdiet est vitae ex luctus molestie. Sed bibendum velit eget blandit volutpat. Nullam eu tincidunt mi. Phasellus ut laoreet ligula, fermentum bibendum lorem. Quisque sit amet ex dui. Nam ut posuere metus. Ut consectetur justo ac dui vestibulum, at varius orci rhoncus. Cras sollicitudin ullamcorper neque. Etiam porta sodales tellus vitae hendrerit.</td>
				</tr>
			</table>	
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr class="tr1">
				...
				<tr class="tr2">
					<td class="td1"><img src="./images/a.png" alt=""/></td>
					<td class="td2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla ut tincidunt nisi, sed venenatis orci. In rhoncus mollis ante, eget dictum velit aliquam vitae. Quisque turpis lacus, convallis finibus ipsum vitae, facilisis commodo lacus. Ut imperdiet est vitae ex luctus molestie. Sed bibendum velit eget blandit volutpat. Nullam eu tincidunt mi. Phasellus ut laoreet ligula, fermentum bibendum lorem. Quisque sit amet ex dui. Nam ut posuere metus. Ut consectetur justo ac dui vestibulum, at varius orci rhoncus. Cras sollicitudin ullamcorper neque. Etiam porta sodales tellus vitae hendrerit. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla ut tincidunt nisi, sed venenatis orci. In rhoncus mollis ante, eget dictum velit aliquam vitae. Quisque turpis lacus, convallis finibus ipsum vitae, facilisis commodo lacus. Ut imperdiet est vitae ex luctus molestie. Sed bibendum velit eget blandit volutpat. Nullam eu tincidunt mi. Phasellus ut laoreet ligula, fermentum bibendum lorem. Quisque sit amet ex dui. Nam ut posuere metus. Ut consectetur justo ac dui vestibulum, at varius orci rhoncus. Cras sollicitudin ullamcorper neque. Etiam porta sodales tellus vitae hendrerit.</td>
				</tr>
			</table>	
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr class="tr1">
