...
$sendmail_87 = APP::Module('DB')->Select(
...
$sendmail_92 = APP::Module('DB')->Select(
    APP::Module('Tunnels')->settings['module_tunnels_db_connection'], ['fetch', PDO::FETCH_COLUMN], 
    ['UNIX_TIMESTAMP(cr_date)'], 'tunnels_tags',
    [
        ['user_tunnel_id', '=', $data['id'], PDO::PARAM_INT],
...
$action_start = $sendmail_92 ? $sendmail_92 : $sendmail_87;
$action_end = strtotime('+78 hours', $action_start);
...
- о секретных "фишках", которые позволят вам экономить и быть уверенной в качестве товара.</p><br>
    ...
    <div class="block15-2">    
        ...
        <p style="color: #fff; font-size: 20px; font-family: 'Roboto Light', arial; line-height: 24px;">Стандартная цена курса "Как покупать брендовые вещи со скидкой до 90%" - 4900 рублей. Но вы можете получить его бесплатно. Для этого успейте заказать имидж-практику "Шоппинг осень-зима под контролем стилиста" 3 и 4 сентября (четверг и пятницу)</p>
...
- какие цветовые решения будут выигрышными именно для вас.</p> 	
	...
	<div class="block18" id="point6">
		<div class="ins">
            ...
            <div class="bl_name">Успейте записаться со скидкой, пока время на таймере не истечет</div>
...
var clock = $('.clock').FlipClock(diff, {
    ...
    language: 'ru'
                        ...
                        <br><br><br><br><br>
                        <div class="bl_name">Супер-бонус</div>
                           
              <section style="padding: 50px 70px;" class="page3">
        <img src="<?= APP::Module('Routing')->root ?>public/modules/pages/products/shopping-fw/images/bns1-2.png" style="position: absolute; top: 0px; left: 0px; z-index: 5;">
        <h2 style="color: #a2e5ff; margin: 90px 0 300px 250px;">&nbsp;</h2>
        <div style="display: block; width: 465px; height: 180px; position: absolute; top: 60px; right: 270px; border: 2px solid #fff; z-index: 2;">
           <p style="margin: 5px 5px 5px 90px; color: #000; font-size: 20px;">Если вы успеете заказать имидж-практику в числе первых 100 клиентов, вы получаете бонусом курс "Как покупать брендовые вещи со скидкой до 90%" (<strike>4900 руб</strike>). Если вы видите эту надпись, значит для вас действует это предложение.</p>
        </div>
    </section>
			...
			<div class="name">ВЫ ПОЛУЧАЕТЕ:</div>
				<div class="bl1">
					<ul>
                        ...
                        <li>Тенденции сезона осень-зима 2017/2018 и как их применить для вашего гардероба <strike>(1000 руб.)</strike> </li>
				...
				<div class="bl2">
					...
					<div class="price2"><strike>14 470 руб</strike></div>
                  <div class="price">4 970 руб</div>
					<a href="https://www.glamurnenko.ru/order/?p=<?= APP::Module('Crypt')->Encode('{"id":"53286"}') ?>&t=<?= APP::Module('Crypt')->Encode('{"email":"' . APP::Module('DB')->Select(APP::Module('Users')->settings['module_users_db_connection'], ['fetch', PDO::FETCH_COLUMN], ['email'], 'users', [['id', '=', $data['user_id'], PDO::PARAM_INT]]) . '"}') ?>" target="_blank">ЗАПИСАТЬСЯ</a>
				</div>
		  </div>
			<div class="break"></div>
		</div>
...
- цена тренинга намного ниже, чем цены живых мероприятий.</td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr class="tr1">
					<td class="td1"><img src="<?= APP::Module('Routing')->root ?>public/modules/pages/products/shopping-fw/images/q.png" alt=""/></td>
					<td class="td2">Я не успеваю сейчас оплатить!</td>
				</tr>
				<tr class="tr2">
					<td class="td1"><img src="<?= APP::Module('Routing')->root ?>public/modules/pages/products/shopping-fw/images/a.png" alt=""/></td>
					<td class="td2">Нажмите на кнопку заказать, заполните данные о себе и выберите способ оплаты. К вам на email придет информация о заказе. Сохраните её для того, чтобы оплатить на днях. Оплатить можно до <span style="color: #FF0004"><?= date('j', $payment_end) . ' ' . $months[date('m', $payment_end)] ?></span></td>
				</tr>
			</table>	
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr class="tr1">
