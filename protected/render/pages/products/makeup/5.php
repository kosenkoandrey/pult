		...
		<div class="price">
			<div class="inn">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr class="tr2">
						<td class="td1"><span><strong>Цена</strong></span></td>
                        
						<td>9 875 руб</td>
					</tr>
					<tr class="tr3">
						<td class="td1"></td>
						<td><a target="_blank" href="https://www.glamurnenko.ru/order/?p=<?= APP::Module('Crypt')->Encode('{"id":"53265"}') ?>&t=<?= APP::Module('Crypt')->Encode('{"email":"' . APP::Module('DB')->Select(APP::Module('Users')->settings['module_users_db_connection'], ['fetch', PDO::FETCH_COLUMN], ['email'], 'users', [['id', '=', $data['user_id'], PDO::PARAM_INT]]) . '"}') ?>"></a></td>
					</tr>
				</table>
			</div>
		</div>	
