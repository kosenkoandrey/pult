			...
			<div class="item i1">
				<div class="inn">
					...
					<div class="right">
						...
						<div class="descr">
							<p><img class="leftimg" src="<?= APP::Module('Routing')->root ?>public/modules/pages/products/makeup/images/004box.png" width="300" height="409" alt=""/><br><p><span>Бонус 1. Особенности макияжа 30+<br> на примере Анджелины Джоли в фильме “Турист”</span></p><br>- Какие особенности макияжа нужно знать, чтобы выглядеть идеально после  30;<br>
				...
				<div class="inn">
					...
					<div class="right">
						...
						<div class="descr">
                          ...
                          <p><span>Бонус 2. Особенности макияжа 40 +</span></p><br>
            ...
            <div class="item i3">
				<div class="inn">
					...
					<div class="right">
						...
						<div class="descr">
                          <p>
<img class="leftimg" src="<?= APP::Module('Routing')->root ?>public/modules/pages/products/makeup/images/006box.png" width="300" height="409" alt=""/><br><p><span>Бонус 3. Особенности макияжа 50+</span></p><br>- Как правильно ухаживать и подготавливать кожу к нанесению макияжа<br>
- Как текстуры и цвета косметики сделают ваше лицо моложе и свежее.<br>
		...
		<div class="price">
			<div class="inn">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
			        ...
			        <tr>
						<td class="td1">Бонус 1. Особенности макияжа 30+ на примере Анджелины Джоли в фильме Турист<br><br>
						Бонус 2. Особенности макияжа 40+<br><br>
						Бонус 3. Особенности макияжа 50+ </td>
