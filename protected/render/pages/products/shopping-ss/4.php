...
<? } ?>
	...
	<div class="block13" id="point6">
		<div class="ins">
			<div class="corn"></div>
			<div class="block">
				<div class="bl_name"><span>ЗАПИСАТЬСЯ НА ИМИДЖ-ПРАКТИКУ</span></div><br><br><br><br>	
				<div class="price">
					<div class="inn">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr class="tr3">
								<td class="td1"></td>
							    <td><a href="https://www.glamurnenko.ru/order/?p=<?= APP::Module('Crypt')->Encode('{"id":"53257"}') ?>&t=<?= APP::Module('Crypt')->Encode('{"email":"' . APP::Module('DB')->Select(APP::Module('Users')->settings['module_users_db_connection'], ['fetch', PDO::FETCH_COLUMN], ['email'], 'users', [['id', '=', $data['user_id'], PDO::PARAM_INT]]) . '"}') ?>" target="_blank"></a></td>
							</tr>
						</table>
