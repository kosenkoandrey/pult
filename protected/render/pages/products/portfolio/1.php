...
Успешно и без затрат создала с нуля собственное портфолио. А также обучает других имиджмейкеров этому. Результаты можете посмотреть ниже в отзывах</div>
	...
	<div class="block15" id="point6"><br/>
		<div class="ins">
<center>			<div class="txt1">ЗАПИСЫВАЙТЕСЬ ПРЯМО СЕЙЧАС!</div></center>
...
if (APP::Module('DB')->Select(
    ...
    ?>
    <center>			<div class="txt1">
				Запишитесь в предварительный список сейчас, <br/>чтобы получить скидку
			<br/><br/>
				Записаться на тренинг вы сможете <br/>в ближайшие несколько дней
			</div></center>

<center><iframe style="width: 700px; height: 520px; border: 0px solid #dddddd; padding: 10px;" src="<?= APP::Module('Routing')->root ?>products/portfolio/form?email=<?= $user_email ?>&user_tunnel_id=<?= $data['id'] ?>&user_id=<?=$data['user_id']?>" frameborder="0" scrolling="no" name="frame1"></iframe>
</center>
    <?
}
?> 
...
<tr>
<td colspan="2"><center><a style="text-align: center;" href="https://www.glamurnenko.ru/blog/wp-content/uploads/2015/04/Mila-Goomanovsky33.jpg" target="_blank"><img src="https://www.glamurnenko.ru/blog/wp-content/uploads/2015/04/Mila-Goomanovsky33.jpg" alt="" width="600" height="400" /></a></center></td>
</tr>
<tr>
<td><a style="text-align: center;" href="https://www.glamurnenko.ru/blog/wp-content/uploads/2015/04/Mila-Goomanovsky34.jpg" target="_blank"><img src="https://www.glamurnenko.ru/blog/wp-content/uploads/2015/04/Mila-Goomanovsky34.jpg" alt="" width="300" height="449" /></a></td>
<td><a style="text-align: center;" href="https://www.glamurnenko.ru/blog/wp-content/uploads/2015/04/Mila-Goomanovsky35.jpg" target="_blank"><img src="https://www.glamurnenko.ru/blog/wp-content/uploads/2015/04/Mila-Goomanovsky35.jpg" alt="" width="300" height="449" /></a></td>
</tr>
<tr>
<td colspan="2"><center><a style="text-align: center;" href="https://www.glamurnenko.ru/blog/wp-content/uploads/2015/04/Mila-Goomanovsky36.jpg" target="_blank"><img src="https://www.glamurnenko.ru/blog/wp-content/uploads/2015/04/Mila-Goomanovsky36.jpg" alt="" width="300" height="449" /></a></center></td>
</tr>
</tbody>
</table>
					</center> </p>
