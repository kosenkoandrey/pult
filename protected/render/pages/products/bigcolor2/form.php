...
<link rel="stylesheet" href="<?= APP::Module('Routing')->root ?>public/modules/pages/products/bigcolor2/form/style_form.css">
                            ...
                            $.ajax({
                                ...
                                success: function(data) {
                                    $.ajax({
                                        ...
                                        success: function(data) {
                                            window.top.location.href = "<?= APP::Module('Routing')->root ?>products/bigcolor2/activate";
                                        }
                                    });
                                }
                            });
