...
<link rel="stylesheet" href="<?= APP::Module('Routing')->root ?>public/modules/pages/products/imageschool-new/preentry/form.css">
                            ...
                            $.ajax({
                                ...
                                success: function(data) {
                                    $.ajax({
                                        ...
                                        success: function(data) {
                                            window.top.location.href = "<?= APP::Module('Routing')->root ?>products/imageschool-new/preentry/success";
                                        }
                                    });
                                }
                            });
...
<form style="margin: 0; padding: 0;" target="_blank" name="SR_form" target="_parent" onSubmit="return SR_submit(this)">
