...
$usersend = "imageschoolnew_notification@glamurnenko.ru";
// Формирование заголовка письма
$subject  = "Школа Имиджмейкеров - оповестить о скидках";
...
if(@mail($sendto, $subject, $msg, $headers)) {
	?>
        ...
        <link rel="stylesheet" href="<?= APP::Module('Routing')->root ?>public/modules/pages/products/imageschool-new/notification/success.css">
        <link href="https://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,800italic,400,300,600,700,800" rel="stylesheet" type="text/css">
        <title>Онлайн Школа Имиджмейкеров Екатерины Маляровой</title>
        ...
        <body class=" color-aramis color-aramis">
                <div class="panel">
                        <div class="header">
                                <h1 ql-id="headline" ql-editable="text">Онлайн Школа Имиджмейкеров Екатерины Маляровой</h1>
                        </div>
                        <div class="inner-wrap">
                                <p>Вы записаны в список ожидания на тренинг &laquo;Онлайн Школа Имиджмейкеров Екатерины Маляровой&raquo;.</p>
