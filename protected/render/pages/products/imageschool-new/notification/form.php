...
<link rel="stylesheet" href="<?= APP::Module('Routing')->root ?>public/modules/pages/products/imageschool-new/notification/form.css">
            ...
            $.ajax({
                                ...
                                success: function(data) {
                                    $.ajax({
                                        ...
                                        success: function(data) {
                                            window.top.location.href = "<?= APP::Module('Routing')->root ?>products/imageschool-new/notification/success?email=" + f["email"].value + '&tel=' + f["tel"].value + '&firstname=' + f["firstname"].value;
                                        }
                                    });
                                }
                            });
...
<form style="margin: 0; padding: 0;" name="SR_form" target="_parent" onSubmit="return SR_submit(this)">
          ...
          <button id="submit-preform" ql-name="Call To Action Button" ql-editable="button" type="submit" class="btn">ОПОВЕСТИТЕ МЕНЯ<br></button>
        </form>
