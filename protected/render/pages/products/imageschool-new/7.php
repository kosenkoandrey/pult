...
<div class="clearfix article-outer-sidebar">
	<div class="article-inner">
		<div class="article-container clearfix">
			<div class="fs16 arial the-content">
<center><p><strong>Запись на тренинг закрыта.<br/> Оставьте свои контакты и мы оповестим вас о следующем наборе</strong></center>
</p>
  <center><iframe style="width: 700px; height: 580px; border: 0px solid #dddddd;" src="<?= APP::Module('Routing')->root ?>products/imageschool-new/notification/form?email=<?= $user_email ?>&user_tunnel_id=<?= $data['id'] ?>&user_id=<?=$data['user_id']?>" frameborder="0" scrolling="no" name="frame1"></iframe></center>
</div>
		</div>
	</div>
</div>
