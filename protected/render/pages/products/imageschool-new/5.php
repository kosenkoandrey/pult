...
$action_start = APP::Module('DB')->Select(
    ...
    [
        ['user_tunnel_id', '=', $data[0]['id'], PDO::PARAM_INT],
        ['label_id', '=', 'sendmail', PDO::PARAM_STR],
        ['token', '=', '689', PDO::PARAM_STR]
    ]
);
$action_end = strtotime('+216 hours', $action_start);
?>
<!DOCTYPE html>
<html lang="ru-RU">
	<head>
...
<link rel="stylesheet" href="<?= APP::Module('Routing')->root ?>public/modules/pages/products/imageschool-new/flashtimer/compiled/flipclock.css">
<script src="<?= APP::Module('Routing')->root ?>public/modules/pages/products/imageschool-new/flashtimer/compiled/flipclock.js"></script>
...
.block19 .block .ava img{
	border: 5px solid #c6b058 !important;
	-webkit-border-radius: 10px;
	-moz-border-radius: 10px;
	border-radius: 10px;
	behavior: url(./js/PIE.htc);
...
/*	background: url('../images/ico47.png') right top no-repeat;*/
}

blockquote:before {
    float: left;
    margin-top: -0.4em;
    content: url(//www.glamurnenko.ru/images/blockquote_l.png) !important;
}

blockquote:after {
    float: right;
    margin-top: -2.6em;
    content: url(//www.glamurnenko.ru/images/blockquote_r.png) !important;
}
	</style>
...
.block14 table tr td {
	height:32px;
	background:url('https://www.glamurnenko.ru/products/bigcolor/images/bg26.png') repeat;
	text-align:center;
	vertical-align:middle;
...
.block14 table tr td.td1 span {
	text-transform:uppercase;
	font-family: 'Roboto', sans-serif;
}

.block14 table tr.tr1 td {
	height:38px;
	background:none;
...
.block14 table tr.tr2 td.td1 span {
	font-size:17px;
	line-height:17px;
	color:#333;
	font-family: 'Roboto', sans-serif;
...
.block14 table tr.tr3 {
	height:58px;
	font-family: 'Roboto', sans-serif;
}

.block14 table tr.tr3 a {
	margin:0 auto;
	display:block;
	width:114px;
	height:34px;
	text-decoration:none;
	background:url('https://www.glamurnenko.ru/products/bigcolor/images/order.png') no-repeat;
	font-family: 'Roboto', sans-serif;
}
...
.block14 table tr.tr1 td.td2 span {
...
.block14 table tr.tr1 td.td3 span {
	display:inline-block;
	padding:5px 10px;
	border:1px solid #aeafae;
	-webkit-border-radius:5px;
...
.block14 table tr.tr1 td.td4 span {
	display:inline-block;
	padding:5px 10px;
	border:1px solid #aeafae;
	-webkit-border-radius:5px;
...
<body class="page page-id-12736 page-template-default">
    ...
    <div class="clearfix sticky-menu-inner">
            ...
            <div class="table-cell-middle">
				<div class="sticky-logo"><img alt="" src="//www.glamurnenko.ru/blog/wp-content/uploads/2015/10/glamurnenko_white_logo2.png"></div>
            </div>
        ...
        <div class="clearfix site-container-inner-sidebar">
			...
			<div class="top-bar-outer main-container-outer clearfix">
                ...
                <div class="site-top-outer">
					...
					<div class="mission">
						<h3>НАША МИССИЯ:</h3>
						<a>«МИЛЛИОН КРАСИВО ОДЕТЫХ ЖЕНЩИН»</a>
					</div>
...
<br/><br/>
Выпускники Школы работают в моей команде, самостоятельно ходят на шоппинги и проводят консультации или применяют знания в жизни/работе.</p>
							</div>
...
<br/><br/>Александра Пеффер<br/>
			<a href="https://www.facebook.com/aleksandra.bogomaz.1" target="_blank">https://www.facebook.com/aleksandra.bogomaz.1</a></em></p>
								...
								<div id="audiop" class="clearfix article-outer-sidebar" style="padding-bottom: 0px;padding-top: 50px;">
									<div class="article-inner" style="">
										<div class="article-container clearfix">

																		<div class="fs40 playfair page-with-no-image" style="padding-bottom: 0px; text-align: left;">Берем к себе</div>
								...
								<div class="clearfix article-outer-sidebar">
									<div class="article-inner">
										<div class="article-container clearfix">
											<div class="fs16 arial the-content">
			<p>Школа Имиджмейкеров это еще и возможность попасть в мою команду стилистов.
<br/><br/>
Кто-то идет ко мне в команду, кто-то развивается сам, кто-то сначала в моей команде а потом сам. Кто-то сначала сам а потом в команду.
<br/><br/>
Стилистам, которые работают с нами даем клиентов, практику, поддерживаем лично.
<br/><br/>
Вот, например, стилист команды делится прошедшим шоппингом с состоятельной клиенткой:</p>
							</div>
								...
								<audio style="width:650px;" src="https://www.glamurnenko.ru/blog/audio/audio-02.mp3" controls></audio>

								<div class="clearfix article-outer-sidebar" style="padding-bottom: 0px;padding-top: 50px;">
									<div class="article-inner" style="">
										<div class="article-container clearfix">

			                            	<div class="fs40 playfair page-with-no-image" style="padding-bottom: 20px; text-align: left;">25 минут «мяса» — пример домашки со Школы Имиджмейкеров</div>


										</div>
									</div>
								</div>
								<img src="https://www.glamurnenko.ru/blog/images/ekaterina-web.jpg" alt="2-6" width="1060px" class="aligncenter size-full wp-image-1378" >
								<div style="margin: 0 5% 0 5%;width: 90%;color: #888888;font-style: italic;font-size: 13px;text-align: center;line-height: 1.5;"><p class="text" style="padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;font-family:Helvetica,Arial,sans-serif;font-size:12px;font-weight:normal;line-height:22px;Margin:1em 0px;margin-top: 0px;">На фотографии я веду один из вебинаров. Таким же способом я проверяю домашние задания студентов Школы Имиджмейкеров — голосом давая комментарии к ним.</p></div>
								<div class="clearfix article-outer-sidebar" style="padding-bottom: 0px;padding-top: 50px;">
						<div class="article-inner" style="">
							<div class="article-container clearfix">

                            	<div class="fs40 playfair page-with-no-image" style="padding-bottom: 0px; text-align: left;">АУДИО-ВЕРСИЯ МОИХ КОММЕНТАРИЕВ</div>


							</div>
						</div>
					</div><br/><br/>
								<audio style="width:650px;" src="https://www.glamurnenko.ru/blog/audio/audio-01.mp3" controls></audio>
								<div class="clearfix article-outer-sidebar" style="padding-bottom: 0px;padding-top: 50px;">
									<div class="article-inner" style="">
										<div class="article-container clearfix">

			                            	<div class="fs40 playfair page-with-no-image" style="padding-bottom: 0px; text-align: left;">В аудио вы услышите ответы на вопросы:</div>
								...
								<div class="clearfix article-outer-sidebar">
									<div class="article-inner">
										<div class="article-container clearfix">
											<div class="fs16 arial the-content">
			<p>– Надо ли имиджмейкеру на шоппинге слушать клиента? Что говорить, чтобы клиент слушался? Подстраиваться под клиента или нет? С какими клиентами работать, а с какими нет? Честность при работе с клиентами.
<br/><br/>
&ndash; Правило антиэйдж гардероба.
<br/><br/>
&ndash; Когда сумма на шоппинг начинает увеличиваться в разы?
<br/><br/>
&ndash; Как подготовить клиента к переменам? Что делать, если клиент еще не готов что-то носить?
<br/><br/>
&ndash; План А, Б, В, Г, Д и т.д. на шоппинге.
<br/><br/>
&ndash; Как работать с продавцами: болтливыми, ленивыми, неприветливыми?
<br/><br/>
&ndash; Надо ли торговаться за скидки? Что делать, если клиент торгуется?
<br/><br/>
А еще 5 историй с моих шоппингов и россыпь практических советов.</p>
							</div>
...
У вас постоянно будет доступ в этот раздел. Если вы что-то пропустили, в любой момент вы сможете вернуться и повторно переслушать записи и работать в удобном для вас темпе.</p>
								...
								<div class="clearfix article-outer-sidebar">
									<div class="article-inner">
										<div class="article-container clearfix">
											<div class="fs16 arial the-content">
								<p>В процессе обучения вы выкладываете свои домашние задания и вопросы, а я на них отвечаю. У вас будет моя поддержка и обратная связь на протяжении 4 месяцев!
<br/><br/>
Также вы будете видеть домашние задания других участников, а также их разбор.
<br/><br/>
Это позволяет прямо во время обучения накопить бесценный опыт различных ситуаций на собственном примере и примере других учеников.
<br/><br/>
Выше я уже прикрепляла пример моего аудио-ответа на домашнее задание стилиста. Дублирую и здесь:
</p>
								</div>
										</div>
									</div>
...
Я постаралась сделать так, чтобы эта инвестиция была самой выгодной в вашей жизни.
								...
								<div class="clearfix article-outer-sidebar" style="padding-bottom: 0px;padding-top: 50px;">
									<div class="article-inner" style="">
										<div class="article-container clearfix">
			                            	...
			                            	<div class="fs40 playfair page-with-no-image" style="padding-bottom: 0px; text-align: left;">Обучайтесь без риска</div>
								...
								<div class="clearfix article-outer-sidebar">
									<div class="article-inner">
										<div class="article-container clearfix">
											<div class="fs16 arial the-content">
								<p>А еще я сделала так, чтобы вы без риска могли попробовать обучение.
<br/><br/>
В течение 30 дней действует гарантия возврата средств. Если вам что-то не понравится в процессе обучения, просто дайте мне знать, и я верну деньги.
<br/><br/>
Без лишних вопросов. Без проблем. И без обид.
</p>
								</div>
										</div>
									</div>
								</div>
	<div id="menu4" class="block14">
<div class="bg">
<div class="ins">
<div class="clearfix article-outer-sidebar" style="padding-bottom: 0px;padding-top: 50px;">
	<div class="article-inner" style="">
		<div class="article-container clearfix">
										...
										<div class="fs40 playfair page-with-no-image" style="padding-bottom: 0px;padding-top: 0px; text-align: center;">ЗАПИШИТЕСЬ В НОВЫЙ ПОТОК ПРЯМО СЕЙЧАС</div>
...
<br><br>
<div class="bl_name" style="font-family: 'Roboto', sans-serif;">Запись со скидкой идет, пока время на таймере не истекло:
</div>
<br/><br/>
...
<br/><br/>
	...
	<tbody><tr class="tr1">
		...
		<td class="td4"></td>
		<td class="td4"></td>
		<td class="td4" style="border-radius: 0px 5px 0px 0px;"></td>
	</tr>
	<tr>
		<td class="td1"></td>
		<td>STANDART</td>
	...
	<tr style="background-color: #03d503;">
		<td class="td1"><strong>Участие в Школе Имиджмейкеров</strong></td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/yes.png" alt=""></td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/yes.png" alt=""></td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/yes.png" alt=""></td>
	</tr>
	<tr>
...
">
		<td class="td1"><strong>Все тренинги по персональному имиджу (без проверки домашних заданий):</strong></td>
		<td></td>
		<td></td>
		<td></td>
	</tr>
    ...
    background-color: yellow;
">
		<td class="td1">Икона стиля</td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/no.png" alt=""></td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/yes.png" alt=""></td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/yes.png" alt=""></td>
	</tr>
	<tr style="
    background-color: yellow;
">
		<td class="td1">Гардероб на 100%. 20 базовых вещей и 200 комплектов с ними</td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/no.png" alt=""></td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/yes.png" alt=""></td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/yes.png" alt=""></td>
	</tr>
...
">
    ...
    background-color: yellow;
">
		<td class="td1">Как похудеть на 2 размера с помощью имиджмейкера</td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/no.png" alt=""></td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/yes.png" alt=""></td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/yes.png" alt=""></td>
	</tr>
    ...
    background-color: yellow;
">
		<td class="td1">Имидж-практика «Верхняя одежда под контролем стилиста»</td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/no.png" alt=""></td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/yes.png" alt=""></td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/yes.png" alt=""></td>
	</tr>
    ...
    background-color: yellow;
">
		<td class="td1">Имидж-практика «Головные уборы под контролем стилиста»</td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/no.png" alt=""></td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/yes.png" alt=""></td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/yes.png" alt=""></td>
	</tr>
    ...
    background-color: yellow;
">
		<td class="td1">Революция цвета</td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/no.png" alt=""></td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/yes.png" alt=""></td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/yes.png" alt=""></td>
	</tr>
    ...
    background-color: yellow;
">
		<td class="td1">Имидж-практика «Шоппинг весна-лето под контролем стилиста»</td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/no.png" alt=""></td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/yes.png" alt=""></td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/yes.png" alt=""></td>
	</tr>
    ...
    background-color: yellow;
">
		<td class="td1">Имидж-практика «Шоппинг осень-зима под контролем стилиста»</td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/no.png" alt=""></td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/yes.png" alt=""></td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/yes.png" alt=""></td>
	</tr>
    ...
    background-color: yellow;
">
		<td class="td1">MakeUp Must Have: идеально подходящий вам макияж за 15 минут в день</td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/no.png" alt=""></td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/yes.png" alt=""></td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/yes.png" alt=""></td>
	</tr>
...
">
		<td class="td1"><strong>Профессиональные тренинги (без проверки домашних заданий):</strong></td>
		<td></td>
		<td></td>
		<td></td>
	</tr>
    ...
    background-color: #0d7946;
">
		<td class="td1">1000 интернет-клиентов для имиджмейкера</td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/no.png" alt=""></td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/no.png" alt=""></td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/yes.png" alt=""></td>
	</tr>
    ...
    background-color: #0d7946;
">
		<td class="td1">Имидж-практика «Портфолио для имиджмейкера за 1 месяц»</td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/no.png" alt=""></td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/no.png" alt=""></td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/yes.png" alt=""></td>
	</tr>
...
">
		<td class="td1"><strong>Присутствие на моих шоппингах в Москве или Милане на выбор:</strong></td>
		<td></td>
		<td></td>
		<td></td>
	</tr>
    ...
    background-color: #49116d;
">
		<td class="td1">В Москве 3 шоппинга</td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/no.png" alt=""></td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/no.png" alt=""></td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/yes.png" alt=""></td>
	</tr>
    ...
    background-color: #49116d;
">
		<td class="td1">В Милане 2 дня</td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/no.png" alt=""></td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/no.png" alt=""></td>
		<td><img src="https://www.glamurnenko.ru/products/bigcolor/images/yes.png" alt=""></td>
	</tr>
	...
	<tr class="tr2">
		<td class="td1"><strong>Полная цена</strong></td>
		<td><strike><strong>49 900 руб.</strong></strike></td>
		<td><strike><strong>99 900 руб.</strong></strike></td>
		<td><strike><strong>300 000 руб.</strong></strike></td>
	</tr>
	
	
        <?
        if (array_search('693', $data[1]['sendmail']) !== false) {
            ?>
            <!-- 9 письмо -->
            <tr class="tr2">
                    <td class="td1"><strong>Скидка</strong></td>
                    <td><strong>32%</strong></td>
                    <td><strong>46%</strong></td>
                    <td><strong>41%</strong></td>
            </tr>
            <tr class="tr2">
                    <td class="td1"><strong>Ваша цена</strong></td>
                    <td><strong>33 900 руб.</strong></td>
                    <td><strong>53 900 руб.</strong></td>
                    <td><strong>175 000 руб.</strong></td>
            </tr>
            <tr class="tr3">
                    <td class="td1"></td>
                    <td><a href="https://www.glamurnenko.ru/order/?p=<?= APP::Module('Crypt')->Encode('{"id":"53417","amount":"33900"}') ?>&t=<?= APP::Module('Crypt')->Encode('{"email":"' . APP::Module('DB')->Select(APP::Module('Users')->settings['module_users_db_connection'], ['fetch', PDO::FETCH_COLUMN], ['email'], 'users', [['id', '=', $data[0]['user_id'], PDO::PARAM_INT]]) . '"}') ?>&f=1" target="_blank" data-vivaldi-spatnav-clickable="1"></a></td>
                    <td><a href="https://www.glamurnenko.ru/order/?p=<?= APP::Module('Crypt')->Encode('{"id":"53418","amount":"53900"}') ?>&t=<?= APP::Module('Crypt')->Encode('{"email":"' . APP::Module('DB')->Select(APP::Module('Users')->settings['module_users_db_connection'], ['fetch', PDO::FETCH_COLUMN], ['email'], 'users', [['id', '=', $data[0]['user_id'], PDO::PARAM_INT]]) . '"}') ?>&f=1" target="_blank" data-vivaldi-spatnav-clickable="1"></a></td>
                    <td><a href="https://www.glamurnenko.ru/order/?p=<?= APP::Module('Crypt')->Encode('{"id":"53419","amount":"175000"}') ?>&t=<?= APP::Module('Crypt')->Encode('{"email":"' . APP::Module('DB')->Select(APP::Module('Users')->settings['module_users_db_connection'], ['fetch', PDO::FETCH_COLUMN], ['email'], 'users', [['id', '=', $data[0]['user_id'], PDO::PARAM_INT]]) . '"}') ?>&f=1" target="_blank" data-vivaldi-spatnav-clickable="1"></a></td>
            </tr>
            <?
        } else 
        if (array_search('692', $data[1]['sendmail']) !== false) {
            ?>
            <!-- 8 письмо -->
            <tr class="tr2">
                    <td class="td1"><strong>Скидка</strong></td>
            ...
            <tr class="tr2">
                    <td class="td1"><strong>Ваша цена</strong></td>
                    <td><strong>32 900 руб.</strong></td>
                    <td><strong>52 900 руб.</strong></td>
                    <td><strong>170 000 руб.</strong></td>
            </tr>
            <tr class="tr3">
                    <td class="td1"></td>
                    <td><a href="https://www.glamurnenko.ru/order/?p=<?= APP::Module('Crypt')->Encode('{"id":"53417","amount":"32900"}') ?>&t=<?= APP::Module('Crypt')->Encode('{"email":"' . APP::Module('DB')->Select(APP::Module('Users')->settings['module_users_db_connection'], ['fetch', PDO::FETCH_COLUMN], ['email'], 'users', [['id', '=', $data[0]['user_id'], PDO::PARAM_INT]]) . '"}') ?>&f=1" target="_blank" data-vivaldi-spatnav-clickable="1"></a></td>
                    <td><a href="https://www.glamurnenko.ru/order/?p=<?= APP::Module('Crypt')->Encode('{"id":"53418","amount":"52900"}') ?>&t=<?= APP::Module('Crypt')->Encode('{"email":"' . APP::Module('DB')->Select(APP::Module('Users')->settings['module_users_db_connection'], ['fetch', PDO::FETCH_COLUMN], ['email'], 'users', [['id', '=', $data[0]['user_id'], PDO::PARAM_INT]]) . '"}') ?>&f=1" target="_blank" data-vivaldi-spatnav-clickable="1"></a></td>
                    <td><a href="https://www.glamurnenko.ru/order/?p=<?= APP::Module('Crypt')->Encode('{"id":"53419","amount":"170000"}') ?>&t=<?= APP::Module('Crypt')->Encode('{"email":"' . APP::Module('DB')->Select(APP::Module('Users')->settings['module_users_db_connection'], ['fetch', PDO::FETCH_COLUMN], ['email'], 'users', [['id', '=', $data[0]['user_id'], PDO::PARAM_INT]]) . '"}') ?>&f=1" target="_blank" data-vivaldi-spatnav-clickable="1"></a></td>
            </tr>
            <?
        } else 
        if (array_search('691', $data[1]['sendmail']) !== false) {
            ?>
            <!-- 7 письмо -->
            <tr class="tr2">
                    <td class="td1"><strong>Скидка</strong></td>
            ...
            <tr class="tr2">
                    <td class="td1"><strong>Ваша цена</strong></td>
                    <td><strong>31 900 руб.</strong></td>
                    <td><strong>51 900 руб.</strong></td>
                    <td><strong>165 000 руб.</strong></td>
            </tr>
            <tr class="tr3">
                    <td class="td1"></td>
                    <td><a href="https://www.glamurnenko.ru/order/?p=<?= APP::Module('Crypt')->Encode('{"id":"53417","amount":"31900"}') ?>&t=<?= APP::Module('Crypt')->Encode('{"email":"' . APP::Module('DB')->Select(APP::Module('Users')->settings['module_users_db_connection'], ['fetch', PDO::FETCH_COLUMN], ['email'], 'users', [['id', '=', $data[0]['user_id'], PDO::PARAM_INT]]) . '"}') ?>&f=1" target="_blank" data-vivaldi-spatnav-clickable="1"></a></td>
                    <td><a href="https://www.glamurnenko.ru/order/?p=<?= APP::Module('Crypt')->Encode('{"id":"53418","amount":"51900"}') ?>&t=<?= APP::Module('Crypt')->Encode('{"email":"' . APP::Module('DB')->Select(APP::Module('Users')->settings['module_users_db_connection'], ['fetch', PDO::FETCH_COLUMN], ['email'], 'users', [['id', '=', $data[0]['user_id'], PDO::PARAM_INT]]) . '"}') ?>&f=1" target="_blank" data-vivaldi-spatnav-clickable="1"></a></td>
                    <td><a href="https://www.glamurnenko.ru/order/?p=<?= APP::Module('Crypt')->Encode('{"id":"53419","amount":"165000"}') ?>&t=<?= APP::Module('Crypt')->Encode('{"email":"' . APP::Module('DB')->Select(APP::Module('Users')->settings['module_users_db_connection'], ['fetch', PDO::FETCH_COLUMN], ['email'], 'users', [['id', '=', $data[0]['user_id'], PDO::PARAM_INT]]) . '"}') ?>&f=1" target="_blank" data-vivaldi-spatnav-clickable="1"></a></td>
            </tr>
            <?
        }
        ?>
...
<div class="clearfix article-outer-sidebar">
	<div class="article-inner">
		<div class="article-container clearfix">
			<div class="fs16 arial the-content">
<p class="highlight"><strong>Вы можете внести предоплату в 1000 рублей, чтобы зафиксировать стоимость.</strong>
</p>
<center><a href="https://www.glamurnenko.ru/order/?p=<?= APP::Module('Crypt')->Encode('{"id":"53423"}') ?>&t=<?= APP::Module('Crypt')->Encode('{"email":"' . APP::Module('DB')->Select(APP::Module('Users')->settings['module_users_db_connection'], ['fetch', PDO::FETCH_COLUMN], ['email'], 'users', [['id', '=', $data[0]['user_id'], PDO::PARAM_INT]]) . '"}') ?>&f=1" target="_blank" class="button" style="background-color:rgb(220,20,60);background-image:none;background-repeat:repeat;background-position:top left;background-attachment:scroll;color:#ffffff;font-size:20px;font-weight:bold;font-family:sans-serif;text-align:center;text-decoration:none;display:block;text-transform:uppercase;Margin:2em 0;">
                        <br>
                       ВНЕСТИ ПРЕДОПЛАТУ
                        <br><br>
                    </a></center>
...
<div>
					<blockquote style=""><img src="//www.glamurnenko.ru/blog/images/fomina.png" alt="" style="
						float: left;
						margin: 40px 0px 0px 0px;
				"><p style="text-align:left;margin-left:140px;margin-top: 40px;"><em>После большого вебинара Кати я буквально на подкашивающихся ногах, с сердцем, бешено колотящимся в груди, рванула искать деньги на Школу — это стало моей мечтой, которая буквально вот-вот должна была исполниться. Я испытывала необычайный подъем. Даже сейчас, вспоминая свои ощущения, я испытываю их снова. Ну а 10 сентября каждого года является для меня своеобразным праздником, днем, когда моя жизнь изменилась.
<br/><br/>
Вита Фомина<br/>
<a href="https://www.facebook.com/fomina.vita" target="_blank">https://www.facebook.com/fomina.vita</a></em></p>
</blockquote></div>
...
<div class="clearfix article-outer-sidebar" style="padding-bottom: 0px;padding-top: 50px;">
	<div class="article-inner" style="">
			<div class="article-container clearfix">
										...
										<div class="fs40 playfair page-with-no-image" style="padding-bottom: 0px; text-align: left;">Что произойдет после оплаты?</div>
...
<div class="clearfix article-outer-sidebar">
	<div class="article-inner">
		<div class="article-container clearfix">
			<div class="fs16 arial the-content">
<p>Сразу после оплаты вам придет подтверждение. Доступ в закрытую систему обучения придет к вам в следующий понедельник.
<br/><br/>
3 раза в неделю я буду открывать вам по новому уроку. Вы сможете их просматривать на сайте, а можете скачать.
<br/><br/>
Там же в закрытом разделе вы размещаете свои домашние задания, видите задания других студентов и мои ответы.
<br/><br/>
Все ваши вопросы вы можете задать по телефону или через онлайн-консультант &mdash; мы обязательно разберемся и поможем!
</p>
</div>
		</div>
	</div>
