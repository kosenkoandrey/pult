...
">
	...
	<tr class="tr2">
        ...
        <?
        if (array_search('690', $data[1]['sendmail']) !== false) {
            ?>
            <!-- 6 письмо -->
            <tr class="tr2">
            ...
            <tr class="tr2">
                    ...
                    <td><strong>30 900 руб.</strong></td>
                    <td><strong>50 900 руб.</strong></td>
                    <td><strong>155 000 руб.</strong></td>
            </tr>
            <tr class="tr3">
                    <td class="td1"></td>
                    <td><a href="https://www.glamurnenko.ru/order/?p=<?= APP::Module('Crypt')->Encode('{"id":"53417","amount":"30900"}') ?>&t=<?= APP::Module('Crypt')->Encode('{"email":"' . APP::Module('DB')->Select(APP::Module('Users')->settings['module_users_db_connection'], ['fetch', PDO::FETCH_COLUMN], ['email'], 'users', [['id', '=', $data[0]['user_id'], PDO::PARAM_INT]]) . '"}') ?>&f=1" target="_blank" data-vivaldi-spatnav-clickable="1"></a></td>
                    <td><a href="https://www.glamurnenko.ru/order/?p=<?= APP::Module('Crypt')->Encode('{"id":"53418","amount":"50900"}') ?>&t=<?= APP::Module('Crypt')->Encode('{"email":"' . APP::Module('DB')->Select(APP::Module('Users')->settings['module_users_db_connection'], ['fetch', PDO::FETCH_COLUMN], ['email'], 'users', [['id', '=', $data[0]['user_id'], PDO::PARAM_INT]]) . '"}') ?>&f=1" target="_blank" data-vivaldi-spatnav-clickable="1"></a></td>
                    <td><a href="https://www.glamurnenko.ru/order/?p=<?= APP::Module('Crypt')->Encode('{"id":"53419","amount":"155000"}') ?>&t=<?= APP::Module('Crypt')->Encode('{"email":"' . APP::Module('DB')->Select(APP::Module('Users')->settings['module_users_db_connection'], ['fetch', PDO::FETCH_COLUMN], ['email'], 'users', [['id', '=', $data[0]['user_id'], PDO::PARAM_INT]]) . '"}') ?>&f=1" target="_blank" data-vivaldi-spatnav-clickable="1"></a></td>
            </tr>
            <?
        } else 
        if (array_search('689', $data[1]['sendmail']) !== false) {
            ?>
            <!-- 5 письмо -->
            <tr class="tr2">
                    <td class="td1"><strong>Скидка</strong></td>
            ...
            <tr class="tr2">
                    <td class="td1"><strong>Ваша цена</strong></td>
                    <td><strong>29 900 руб.</strong></td>
                    <td><strong>49 900 руб.</strong></td>
                    <td><strong>150 000 руб.</strong></td>
            </tr>
            <tr class="tr3">
                    <td class="td1"></td>
                    <td><a href="https://www.glamurnenko.ru/order/?p=<?= APP::Module('Crypt')->Encode('{"id":"53417","amount":"29900"}') ?>&t=<?= APP::Module('Crypt')->Encode('{"email":"' . APP::Module('DB')->Select(APP::Module('Users')->settings['module_users_db_connection'], ['fetch', PDO::FETCH_COLUMN], ['email'], 'users', [['id', '=', $data[0]['user_id'], PDO::PARAM_INT]]) . '"}') ?>&f=1" target="_blank" data-vivaldi-spatnav-clickable="1"></a></td>
                    <td><a href="https://www.glamurnenko.ru/order/?p=<?= APP::Module('Crypt')->Encode('{"id":"53418","amount":"49900"}') ?>&t=<?= APP::Module('Crypt')->Encode('{"email":"' . APP::Module('DB')->Select(APP::Module('Users')->settings['module_users_db_connection'], ['fetch', PDO::FETCH_COLUMN], ['email'], 'users', [['id', '=', $data[0]['user_id'], PDO::PARAM_INT]]) . '"}') ?>&f=1" target="_blank" data-vivaldi-spatnav-clickable="1"></a></td>
                    <td><a href="https://www.glamurnenko.ru/order/?p=<?= APP::Module('Crypt')->Encode('{"id":"53419","amount":"150000"}') ?>&t=<?= APP::Module('Crypt')->Encode('{"email":"' . APP::Module('DB')->Select(APP::Module('Users')->settings['module_users_db_connection'], ['fetch', PDO::FETCH_COLUMN], ['email'], 'users', [['id', '=', $data[0]['user_id'], PDO::PARAM_INT]]) . '"}') ?>&f1" target="_blank" data-vivaldi-spatnav-clickable="1"></a></td>
            </tr>
            <?
        }
        ?>
