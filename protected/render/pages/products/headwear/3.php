...
<center>			<div class="bl_name"><span>ЗАПИСЫВАЙТЕСЬ ПРЯМО СЕЙЧАС!</span></div></center>
				...
				<tr>
					...
					<tr class="tr3">
						...
						<td><a href="https://www.glamurnenko.ru/order/?p=<?= APP::Module('Crypt')->Encode('{"id":"53232"}') ?>&t=<?= APP::Module('Crypt')->Encode('{"email":"' . APP::Module('DB')->Select(APP::Module('Users')->settings['module_users_db_connection'], ['fetch', PDO::FETCH_COLUMN], ['email'], 'users', [['id', '=', $data['user_id'], PDO::PARAM_INT]]) . '"}') ?>"></a></td>
					</tr>
				</table>
			</div>
		</div>
