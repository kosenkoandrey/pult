...
&ndash; вы сможете сделать текущий гардероб более актуальным и эффектным, добавив в него лишь несколько оттенков нового сезона.</p>
			...
			<div class="item i8">
				<div class="label"></div>
				<div class="left"><img src="https://www.glamurnenko.ru/products/shopping-fw/images/bns2-2.png" alt="" style="margin-top: 53px;"></div>
				<div class="right">
					<div class="name">Осенние витрины милана идеи для вашего гардероба</div>
					<p style="font-size: 17px;line-height: 17px;">Я планирую сфотографировать лучшие витрины Милана во время осеннего шоппинга и на основе фотографий сделать семинар с идеями для вашего гардероба.</p><br>
				</div>
				<div class="break"></div>
			</div>
			<div class="break"></div>
...
if (APP::Module('DB')->Select(
    ...
    ?>
                <div class="txt">
        <div class="innn"><br>
    <div align="center">Вы уже в списке на получение скидки</div><br>
    </div>
    </div>
    <?
} else { 
    ...
    <div class="txt">
        <div class="innn">
        <center><br>
                    <p>Если вы готовы измениться уже сейчас, то запишитесь в лист ожидания,<br> чтобы не пропустить ближайший набор и получить скидку. </p><br>
                    </center>

        <center><iframe style="width: 700px; height: 580px; border: 0px solid #dddddd;" src="<?= APP::Module('Routing')->root ?>products/icon/preentry/form?email=<?= $user_email ?>&user_tunnel_id=<?= $data['id'] ?>&user_id=<?=$data['user_id']?>" frameborder="0" scrolling="no" name="frame1"></iframe></center>
