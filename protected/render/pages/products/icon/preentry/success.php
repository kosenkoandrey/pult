...
<link rel="stylesheet" href="<?= APP::Module('Routing')->root ?>public/modules/pages/products/icon/preentry/success.css">
...
<body class=" color-aramis color-aramis">
	<div class="panel">
		...
		<div class="inner-wrap">
			<p>Поздравляю! Вы записаны в список раннего оповещения о курсе &laquo;Икона Стиля: +100 очков к вашему образу&raquo;.</p>
			<div class="body" ql-id="thank_you_message" ql-editable="body">
			<p>Запись на новый поток будет открыта всего несколько дней. Подробности - в следующих письмах.
