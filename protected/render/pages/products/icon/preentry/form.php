...
<link rel="stylesheet" href="<?= APP::Module('Routing')->root ?>public/modules/pages/products/icon/preentry/form.css">
                            ...
                            $.ajax({
                                ...
                                success: function(data) {
                                    $.ajax({
                                        ...
                                        success: function(data) {
                                            window.top.location.href = "<?= APP::Module('Routing')->root ?>products/icon/preentry/success";
                                        }
                                    });
                                }
                            });
...
<body>
  <div class="wrap">
    <div class="optin animated fadeInDown">
          <h1 ql-id="headline" ql-name="Headline" ql-editable="text">Лист ожидания курса &laquo;Икона Стиля&raquo;</h1>
          <div class="inner-wrap">
            <p ql-id="call_to_action" ql-name="Call To Action" ql-editable="text" style="font-size: 0.9em; text-align:center">Заполните форму и нажмите кнопку <br> &laquoПолучить скидку!&raquo;</p>
    <form style="margin: 0; padding: 0;" name="SR_form" target="_parent" onSubmit="return SR_submit(this)">
              ...
              <button id="submit-preform" ql-id="call_to_action_button" ql-name="Call To Action Button" ql-editable="button" type="submit" class="btn">Получить скидку<br></button>
            </form>
