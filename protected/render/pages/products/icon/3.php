		...
		<div class="ins">
            ...
            <br>
                ...
                <div class="txt">
                                    <div class="innn">
                                    <center><br>
						<p>Запись на тренинг закрыта. Оставьте свои контакты и мы оповестим вас о следующем наборе</p><br>
                                                </center>

                                    <center><iframe style="width: 700px; height: 580px; border: 0px solid #dddddd;" src="<?= APP::Module('Routing')->root ?>products/icon/notification/form?email=<?= $user_email ?>&user_tunnel_id=<?= $data['id'] ?>&user_id=<?=$data['user_id']?>" frameborder="0" scrolling="no" name="frame1"></iframe></center>
