...
<center>			<div class="bl_name">ЗАПИСЫВАЙТЕСЬ ПРЯМО СЕЙЧАС!</div></center>
<?
if (APP::Module('DB')->Select(
    ...
    ?>
    <center><div class="bl_name">
				Вы уже в списке на получение скидки
			</div></center>
    <?
} else { 
    ?>
    <center>			<div class="bl_name"><span>
...
<center><iframe style="width: 700px; height: 520px; border: 0px solid #dddddd; padding: 10px;" src="<?= APP::Module('Routing')->root ?>products/outerwear/form?email=<?= $user_email ?>&user_tunnel_id=<?= $data['id'] ?>&user_id=<?=$data['user_id']?>" frameborder="0" scrolling="no" name="frame1"></iframe>
</center>
    <?
}
?> 
...
<br/>
Выгоды от прохождения имидж-практики: — обратная связь от профессионала<br/>
