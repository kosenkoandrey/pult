...
if(@mail($sendto, $subject, $msg, $headers)) {
	?>
        ...
        <link rel="stylesheet" href="<?= APP::Module('Routing')->root ?>public/modules/pages/products/garderob100new/notification/success.css">
        <link href="https://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,800italic,400,300,600,700,800" rel="stylesheet" type="text/css">
        <title>Гардероб на 100%. 20 базовых вещей и 200 комплектов с ними</title>
        ...
        <body class=" color-aramis color-aramis">
                <div class="panel">
                        <div class="header">
                                <h1 ql-id="headline" ql-editable="text">Гардероб на 100%. 20 базовых вещей и 200 комплектов с ними</h1>
                        </div>
                        <div class="inner-wrap">
                                <p>Вы записаны в список ожидания на тренинг &laquo;Гардероб на 100%. 20 базовых вещей и 200 комплектов с ними&raquo;.</p>
