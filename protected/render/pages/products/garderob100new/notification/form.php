...
<link rel="stylesheet" href="<?= APP::Module('Routing')->root ?>public/modules/pages/products/garderob100new/notification/form.css">
            ...
            $.ajax({
                                ...
                                success: function(data) {
                                    $.ajax({
                                        ...
                                        success: function(data) {
                                            window.top.location.href = "<?= APP::Module('Routing')->root ?>products/garderob100new/notification/success?email=" + f["email"].value + '&tel=' + f["tel"].value + '&firstname=' + f["firstname"].value;
                                        }
                                    });
                                }
                            });
