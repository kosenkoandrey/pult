...
$action_start = APP::Module('DB')->Select(
    ...
    [
        ['user_tunnel_id', '=', $data['tunnel']['id'], PDO::PARAM_INT],
        ['label_id', '=', 'sendmail', PDO::PARAM_STR],
        ['token', '=', '669', PDO::PARAM_STR]
    ]
);

$action_end = strtotime('+156 hours', $action_start);
...
ЗА 10 ДНЕЙ!</div>
	...
	<div class="block4">
		<div class="ins">
			...
			<div class="bl2">
				<img class="pic1" src="/images/ico7.png" alt=""/>
...
if (APP::Module('DB')->Select(
    ...
    ['COUNT(id)'], 'users_tags',
    [
        ['user', '=', $data['tunnel']['user_id'], PDO::PARAM_INT],
...
<div class="bonus3" style="background:url('<?= APP::Module('Routing')->root ?>public/modules/pages/products/garderob100new/images/bonus3.jpg') center top no-repeat; background-color:#eee;">
	...
	<div class="block12" id="sc1">
		<div class="ins">
			...
			<div class="bl3">
				...
				<table border="0" cellspacing="0" cellpadding="0">
					...
					<tr class="tr3">
						...
						<td class="td4 last"><s>9 900 руб.</s></td>
					</tr>
                                        
                                        <?
                                        if (array_search('672', $data['labels']) !== false) {
                                            $price = 5900;
                                            ?>
                                            <tr class="tr3">
                                                <td class="td1" style="padding-bottom: 5px; padding-top: 5px;">Скидка для участников нового потока</td>
                                                <td class="td4 last">40%</td>
                                            </tr>
                                            <tr class="tr4">
                                                    <td class="td1" style="padding-bottom: 5px; padding-top: 5px;">Цена со скидкой</td>
                                                    <td class="td4 last" style="padding-top: 5px;padding-bottom: 5px;"><span id="price">5900</span> <span id="symbol">руб.</span>
            <br/>
            Показать цену в:
            <span id="codes">
                ...
                $(function() {
                    $('#codes > a').click(function() {
                        ...
                        $(this).addClass('active');
                                            ...
                                            <tr class="tr5">
                                                    <td class="td1"></td>
                                                    <td class="td4 last"><a href="https://www.glamurnenko.ru/order/?p=<?= APP::Module('Crypt')->Encode('{"id":"53403","amount":"' . $price . '"}') ?>&t=<?= APP::Module('Crypt')->Encode('{"email":"' . APP::Module('DB')->Select(APP::Module('Users')->settings['module_users_db_connection'], ['fetch', PDO::FETCH_COLUMN], ['email'], 'users', [['id', '=', $data['tunnel']['user_id'], PDO::PARAM_INT]]) . '"}') ?>" target="_blank"></a></td>
                                            </tr>
                                            <?
                                        } else if (array_search('671', $data['labels']) !== false) {
                                            $price = 5500;
                                            ?>
                                            <tr class="tr3">
                                                <td class="td1" style="padding-bottom: 5px; padding-top: 5px;">Скидка для участников нового потока</td>
                                                <td class="td4 last">45%</td>
                                            </tr>
                                            <tr class="tr4">
                                                    <td class="td1" style="padding-bottom: 5px; padding-top: 5px;">Цена со скидкой</td>
                                                    <td class="td4 last" style="padding-top: 5px;padding-bottom: 5px;"><span id="price">5500</span> <span id="symbol">руб.</span>
            <br/>
            Показать цену в:
            <span id="codes">
                <a data-code="RUR" href="javascript:void(0)" class="currency-code active">руб.</a>
                ...
                $(function() {
                    $('#codes > a').click(function() {
                        ...
                        $(this).addClass('active');
                                            ...
                                            <?
                                        } else if (array_search('670', $data['labels']) !== false) {
                                            $price = 5000;
                                            ?>
                                            <tr class="tr3">
                                                <td class="td1" style="padding-bottom: 5px; padding-top: 5px;">Скидка для участников нового потока</td>
                                                <td class="td4 last">49%</td>
                                            </tr>
                                            <tr class="tr4">
                                                    <td class="td1" style="padding-bottom: 5px; padding-top: 5px;">Цена со скидкой</td>
                                                    <td class="td4 last" style="padding-top: 5px;padding-bottom: 5px;"><span id="price">5000</span> <span id="symbol">руб.</span>
            <br/>
            Показать цену в:
            <span id="codes">
                <a data-code="RUR" href="javascript:void(0)" class="currency-code active">руб.</a>
                ...
                $(function() {
                    $('#codes > a').click(function() {
                        ...
                        $(this).addClass('active');
                                            ...
                                            <?
                                        } else if (array_search('669', $data['labels']) !== false) {
                                            $price = 4900;
                                            ?>
                                            <tr class="tr3">
                                                <td class="td1" style="padding-bottom: 5px; padding-top: 5px;">Скидка для участников нового потока</td>
                                                <td class="td4 last">50%</td>
                                            </tr>
                                            <tr class="tr4">
                                                    <td class="td1" style="padding-bottom: 5px; padding-top: 5px;">Цена со скидкой</td>
			...
			<br/><br/>
			<center><p style="font-size: 25px;">Возможность записаться со скидкой закончится через:</p></center><br/><br/>
...
Надеюсь на дальнейшее общение и жду новых семинаров!
	...
	<div class="footer">
		...
		<a href="https://www.glamurnenko.ru/blog/contacts/">https://www.glamurnenko.ru/blog/contacts/</a> tel.: 8(800)707-05-13; +7(499)350-23-35<br>
