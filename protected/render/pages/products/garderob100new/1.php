...
$action_start = APP::Module('DB')->Select(
    ...
    [
        ...
        ['token', '=', '666', PDO::PARAM_STR]
    ]
);

$action_end = strtotime('+6 days', $action_start);
...
<head>
   ...
   <script src="<?= APP::Module('Routing')->root ?>public/modules/pages/products/garderob100new/js/open_text.js" type="text/javascript"></script>
		...
		<div class="ins">
			...
			<div class="bl3">
				...
				<table border="0" cellspacing="0" cellpadding="0">
					...
					<tr class="tr4">
						<td class="td1" style="padding-bottom: 5px; padding-top: 5px;">Цена со скидкой (запишитесь в предварительный список)</td>
						<td class="td4 last">4 900 руб.</td>
					</tr>
				</table>
...
if (APP::Module('DB')->Select(
    ...
    <div class="bl1">
	Запись в новый поток будет доступна с <?= date('j', $action_end) . ' ' . $monthAr[date('m', $action_end)] ?>
    </div>
    <center><iframe style="width: 700px; height: 580px; border: 0px solid #dddddd;" src="<?= APP::Module('Routing')->root ?>products/garderob100new/preentry/form?email=<?= $user_email ?>&user_tunnel_id=<?= $data['id'] ?>&user_id=<?=$data['user_id']?>" frameborder="0" scrolling="no" name="frame1"></iframe></center>
    <?
}
?>                       
