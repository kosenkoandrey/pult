...
<link rel="stylesheet" href="<?= APP::Module('Routing')->root ?>public/modules/pages/products/garderob100new/preentry/form.css">
...
<title>Запишитесь в предварительный список новогодней распродажи</title>
                            ...
                            $.ajax({
                                ...
                                success: function(data) {
                                    $.ajax({
                                        ...
                                        success: function(data) {
                                            window.top.location.href = "<?= APP::Module('Routing')->root ?>products/garderob100new/preentry/success";
                                        }
                                    });
                                }
                            });
...
<form style="margin: 0; padding: 0;" name="SR_form" target="_parent" onSubmit="return SR_submit(this)">
          <div ql-id="optin_email" class="group">
              ...
              <button id="submit-preform" ql-id="call_to_action_button" ql-name="Call To Action Button" ql-editable="button" type="submit" class="btn">ЗАПИСАТЬСЯ<br></button>
        </form>
