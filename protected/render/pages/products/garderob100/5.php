...
<div class="bonus1" style="background:url('<?= APP::Module('Routing')->root ?>public/modules/pages/products/garderob100/images/bonus1.jpg') center top no-repeat; background-color:#189ed2;" id="sc10">
	...
	<div class="case">
		...
		<div class="bonus_name">Бонус 1. &laquo;Тенденции сезона осень-зима 2017-2018 и как их применить для вашего гардероба&raquo;</div>
		<div class="bonus_descr">
			Из этого видео:<br>
			<ul style="margin-bottom: 10px;">
				<li><span>&raquo;</span>&nbsp;&nbsp; вы узнаете, какие тенденции актуальны в сезоне осень-зима 2017-2018;</li>
		...
		<div class="ins">
			...
			<div class="bl3">
				...
				<table border="0" cellspacing="0" cellpadding="0">
					...
					<tr class="tr3">
						<td class="td1" style="padding-bottom: 5px; padding-top: 5px;">Видео-семинар &laquo;Как преобразить ваш гардероб - Тенденции сезона осень-зима 2017-2018 и как их применить для вашего гардероба&raquo;</td>
						<td class="td4 last"><img src="<?= APP::Module('Routing')->root ?>public/modules/pages/products/garderob100/images/yes.png" alt=""/></td>
					</tr>
					<tr class="tr3">
            ...
            <script>
                ...
                $(function() {
					...
					<tr class="tr5">
						<td class="td1"></td>
						<td class="td4 last"><a href="https://www.glamurnenko.ru/order/?p=<?= APP::Module('Crypt')->Encode('{"id":"53102"}') ?>&t=<?= APP::Module('Crypt')->Encode('{"email":"' . APP::Module('DB')->Select(APP::Module('Users')->settings['module_users_db_connection'], ['fetch', PDO::FETCH_COLUMN], ['email'], 'users', [['id', '=', $data['user_id'], PDO::PARAM_INT]]) . '"}') ?>"></a></td>
					</tr>
				</table>
			</div>
