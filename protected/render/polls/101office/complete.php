            ...
            <section id="content">
                <div class="container">
                    <? APP::Render('core/widgets/template/header', 'include', [
                        $data => 'polls/101office/' . APP::Module('Routing')->get['token'],
                        'user_menu' => false
                    ]) ?>
                    <div class="card" style="margin-bottom:0; border-bottom: 1px dotted #ababab;">
                        <div class="card-header"><h2><?= $data ?></h2></div>
                        <div class="card-body card-padding">
                            <b>Хотите подсмотреть за фотосессией для клиентки?</b>
                            <br>
                            Все комплекты мы купили на шоппинге в Милане. Вы еще можете успеть попасть в осенний заезд. <a target="_blank" href="//www.glamurnenko.ru/modules.php?name=Milan">Подробнее</a>
                        </div>
                        <iframe width="100%" height="480" src="//www.youtube.com/embed/sJaaZBX2EpA" frameborder="0" allowfullscreen></iframe>
                    </div>
                    <div class="card">
                        <div class="card-body card-padding">
