            ...
            <section id="content">
                <div class="container">
                    <?  APP::Render('core/widgets/template/header', 'include', [
                            $data['poll'] => 'polls/101office/' . APP::Module('Routing')->get['token'],
                            'user_menu' => false
                        ]) ?>
                                ...
                                switch ($data['step']) {
                                    case 1:
                                        ...
                                        <div class="radio m-b-15">
                                            <label>
                                                <input type="radio" name="answers[46]" value="72">
                                        ...
                                        <div class="radio m-b-15">
                                            <label>
                                                <input type="radio" name="answers[46]" value="73">
                                                <i class="input-helper"></i>
                                        ...
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="answers[46]" value="74">
                                                <i class="input-helper"></i>
                                                ваш вариант
                                            </label>
                                        </div>
                                    ...
                                    case 2:
                                        ...
                                        <div class="radio m-b-15">
                                            <label>
                                                <input type="radio" name="answers[50]" value="75">
                                                <i class="input-helper"></i>
                                        ...
                                        <div class="radio m-b-15">
                                            <label>
                                                <input type="radio" name="answers[50]" value="76">
                                                <i class="input-helper"></i>
                                        ...
                                        <div class="radio m-b-15">
                                            <label>
                                                <input type="radio" name="answers[50]" value="77">
                                                <i class="input-helper"></i>
                                        ...
                                        <div class="radio m-b-15">
                                            <label>
                                                <input type="radio" name="answers[50]" value="78">
                                                <i class="input-helper"></i>
                                        ...
                                        <div class="radio m-b-15">
                                            <label>
                                                <input type="radio" name="answers[50]" value="79">
                                                <i class="input-helper"></i>
                                        ...
                                        <div class="radio m-b-15">
                                            <label>
                                                <input type="radio" name="answers[50]" value="80">
                                                <i class="input-helper"></i>
                                    ...
                                    case 3:
                                        ...
                                        <div class="radio m-b-15">
                                            <label>
                                                <input type="radio" name="answers[51]" value="81">
                                                <i class="input-helper"></i>
                                                да, раз в неделю
                                            </label>
                                        </div>
                                        <div class="radio m-b-15">
                                            <label>
                                                <input type="radio" name="answers[51]" value="82">
                                                <i class="input-helper"></i>
                                                да, раз в месяц
                                            </label>
                                        </div>
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="answers[51]" value="83">
                                                <i class="input-helper"></i>
        ...
        <script>
            $(document).ready(function() {
                ...
                switch ($data['step']) {
                    case 1:
                        ?>
                        $(document).on('click', '[name="answers[46]"]', function() {
                            switch ($('.active[name="answers[46]"]').val()) {
                                case '72':
                                    $('#step1_extra').html('<div style=""><b>Какая цена вас устраивает?</b><br><input class="form-control" type="text" name="answers[47]" value=""></div>');
                                    break;
                                case '73':
                                    $('#step1_extra').html('<div style=""><b>Задайте ваши вопросы</b><br><input class="form-control" type="text" name="answers[48]" value=""></div>');
                                    break;
                                case '74':
                                    $('#step1_extra').html('<div style=""><b>Уточните причину</b><br><input class="form-control" type="text" name="answers[49]" value=""></div>');
                                    break;
                            }
                ...
                $('#step1').submit(function() {
                    var a46 = $('.active[name="answers[46]"]');
                ...
                $('#step2').submit(function() {
                    if ($('.active[name="answers[50]"]').length === 0) { 
                        swal({
                ...
                $('#step3').submit(function() {
                    if ($('.active[name="answers[51]"]').length === 0) { 
                        swal({
