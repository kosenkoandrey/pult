            ...
            <section id="content">
                <div class="container">
                    <? APP::Render('core/widgets/template/header', 'include', [
                        $data => 'polls/wardrobe/' . APP::Module('Routing')->get['token'],
                        'user_menu' => false
                    ]) ?>
                    <div class="card" style="margin-bottom:0; border-bottom: 1px dotted #ababab;">
                        ...
                        <div class="card-body card-padding">
                            ...
                            <br>
                            В ближайшее время я обязательно прочитаю ваш ответ и постараюсь учесть его в следующих письмах. Следите за почтой!
                            <br><br>
                            А пока посмотрите видео с фотосессии для клиентки после шоппинга в Милане.
                        </div>
                        <iframe width="100%" height="480" src="//www.youtube.com/embed/YLY-DoZYrh0" frameborder="0" allowfullscreen></iframe>
                    </div>
                    <div class="card">
                        <div class="card-body card-padding">
