            ...
            <section id="content">
                <div class="container">
                    <? APP::Render('core/widgets/template/header', 'include', [
                        $data => 'polls/outerwear/' . APP::Module('Routing')->get['token'],
                        'user_menu' => false
                    ]) ?>
                    <div class="card" style="margin-bottom:0; border-bottom: 1px dotted #ababab;">
                        ...
                        <div class="card-body card-padding">
                            ...
                            <br>
                            В ближайшие дни я обязательно прочитаю все ответы и учту их в нашей имидж-практике! Следите за письмами!
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-body card-padding">
