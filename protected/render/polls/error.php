                ...
                <div class="container">
                    ...
                    <div class="card" style="margin-bottom:0; border-bottom: 1px dotted #ababab;">
                        ...
                        <div class="card-body card-padding">
                            ...
                            <br>
                            <a href="//glamurnenko.ru" target="_blank" class="btn palette-Deep-Orange bg waves-effect btn-lg m-t-20"><i class="fa fa-external-link" aria-hidden="true"></i> www.glamurnenko.ru</a>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-body card-padding">
