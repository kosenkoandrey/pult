    ...
    <body data-ma-header="teal">
            ...
            <section id="content">
                <div class="container">
                    ...
                    <div class="card" style="margin-bottom:0; border-bottom: 1px dotted #ababab;">
                        <div class="card-header"><h2 style="line-height: 23px; !important"><?= $data['poll'] ?> Поделитесь в чем причина, что в этот раз вы решили не инвестировать в обучение по имиджу и стилю?</h2></div>
                            ...
                            <form method="post" id="step<?= $data['step'] ?>">
                                ...
                                switch ($data['step']) {
                                    case 1:
                                        ...
                                        <textarea rows="7" class="form-control" name="answers[54]" placeholder="Напишите Ваш ответ" style="border: 1px solid #e3e3e3; padding: 10px;"></textarea>
                                        <?
                                        break;
                                }
                                ?>
        ...
        <script>
            $(document).ready(function() {
                autosize($('[name="answers[54]"]'));

                $('#step1').submit(function() {
                    var a54 = $(this).find('[name="answers[54]"]');

                    a54.closest('.form-group').removeClass('has-error has-feedback').find('.form-control-feedback, .help-block').remove();

                    if (a54.val() === '') { 
                        swal({
                            title: 'Поделитесь в чем причина, что в этот раз вы решили не инвестировать в обучение по имиджу и стилю?',
                            type: 'error',
