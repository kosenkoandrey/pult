            ...
            <section id="content">
                <div class="container">
                    <? APP::Render('core/widgets/template/header', 'include', [
                        $data => 'polls/imagemaker/03/' . APP::Module('Routing')->get['token'],
                        'user_menu' => false
                    ]) ?>
                    <div class="card" style="margin-bottom:0; border-bottom: 1px dotted #ababab;">
                        <div class="card-header"><h2><?= $data ?></h2></div>
                        <div class="card-body card-padding">
                            <b>Спасибо, что прошли опрос!</b>
                            <br>
                            В ближайшее время я прочитаю все и постараюсь создать бесплатные материалы, которые будут полезны вам.
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-body card-padding">
