<!DOCTYPE html>
    ...
    <body>
        ...
        <form class="operator" id="operator-yandex" action="https://money.yandex.ru/eshop.xml" method="post">
            ...
            <input type="hidden" name="shopSuccessURL" value="<?= APP::Module('Routing')->root ?>billing/payments/success/<?= APP::Module('Routing')->get['invoice_id_hash'] ?>">
            <input type="hidden" name="shopFailURL" value="<?= APP::Module('Routing')->root ?>billing/payments/fail/<?= APP::Module('Routing')->get['invoice_id_hash'] ?>">
        </form>
        ...
        <form class="operator" id="operator-paypal" action="https://www.paypal.com/row/cgi-bin/webscr" method="post">
            ...
            <input type="hidden" name="return" value="<?= APP::Module('Routing')->root ?>billing/payments/success/<?= APP::Module('Routing')->get['invoice_id_hash'] ?>">
            <input type="hidden" name="cancel_return" value="<?= APP::Module('Routing')->root ?>billing/payments/fail/<?= APP::Module('Routing')->get['invoice_id_hash'] ?>">
            <input type="hidden" name="notify_url" value="<?= APP::Module('Routing')->root ?>billing/payments/operators/paypal/ipn">
        ...
        <form class="operator" id="operator-rbk" action="https://rbkmoney.ru/acceptpurchase.aspx" method="post">
            ...
            <input type="hidden" name="successUrl" value="<?= APP::Module('Routing')->root ?>billing/payments/success/<?= APP::Module('Routing')->get['invoice_id_hash'] ?>">
            <input type="hidden" name="failUrl" value="<?= APP::Module('Routing')->root ?>billing/payments/fail/<?= APP::Module('Routing')->get['invoice_id_hash'] ?>">
        ...
        <form class="operator" id="operator-2checkout" action="https://www.2checkout.com/checkout/purchase" method="post">
            ...
            <input type="hidden" name="return_url" value="<?= APP::Module('Routing')->root ?>billing/payments/success/<?= APP::Module('Routing')->get['invoice_id_hash'] ?>">
        ...
        $fields['WMI_SUCCESS_URL']      = APP::Module('Routing')->root . 'billing/payments/success/' . APP::Module('Routing')->get['invoice_id_hash'];
        $fields['WMI_FAIL_URL']         = APP::Module('Routing')->root . 'billing/payments/fail/' . APP::Module('Routing')->get['invoice_id_hash'];
        ...
        <form class="operator" id="operator-wm" action="https://merchant.webmoney.ru/lmi/payment_utf.asp" method="post">
            ...
            <input type="hidden" name="LMI_PAYMENT_NO" value="<?= $data['invoice']['id'] ?>">
            <input type="hidden" name="LMI_SUCCESS_URL" value="<?= APP::Module('Routing')->root ?>billing/payments/success/<?= APP::Module('Routing')->get['invoice_id_hash'] ?>">
            <input type="hidden" name="LMI_SUCCESS_METHOD" value="GET">
            <input type="hidden" name="LMI_FAIL_URL" value="<?= APP::Module('Routing')->root ?>billing/payments/fail/<?= APP::Module('Routing')->get['invoice_id_hash'] ?>">
            <input type="hidden" name="LMI_FAIL_METHOD" value="GET">
            <input type="hidden" name="LMI_PAYMER_EMAIL" value="<?= $data['invoice']['email'] ?>">
            <input type="hidden" name="LMI_RESULT_URL" value="<?= APP::Module('Routing')->root ?>billing/payments/operators/wm/ipn">
            <input type="hidden" name="oid" value="<?= $data['invoice']['id'] ?>">
        </form>
        
        <div class="modal fade" role="dialog" id="modal-bank-pp" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title">Банковский платеж (физ. лицо)</h4>
                    </div>
                    <div class="modal-body">
                        <form class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" id="bank-pp-lastname" value="<?= isset($data['invoice_details']['lastname']) ? $data['invoice_details']['lastname'] : '' ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 control-label">Имя</label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" id="bank-pp-firstname" value="<?= isset($data['invoice_details']['firstname']) ? $data['invoice_details']['firstname'] : '' ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 control-label">Отчество</label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" id="bank-pp-middlename">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 control-label">Страна</label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" id="bank-pp-country">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 control-label">Область, край</label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" id="bank-pp-region">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 control-label">Город</label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" id="bank-pp-city">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 control-label">Почтовый индекс</label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" id="bank-pp-post-index">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 control-label">Адрес</label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" id="bank-pp-addr">
                                </div>
                            </div>
                        </form>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" id="bank-pp-make">Получить квитанцию</button>
        ...
        <div class="modal fade" role="dialog" id="modal-bank-corp" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title">Банковский платеж (юр. лицо)</h4>
                    </div>
                    <div class="modal-body">
                        <form class="form-horizontal">
                            <div class="form-group">
                                <label class="col-lg-3 control-label">Плательщик</label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" id="bank-corp-company">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 control-label">Реквизиты</label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" id="bank-corp-bank-details">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 control-label">Юр. адрес</label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" id="bank-corp-addr1">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 control-label">Фактический адрес</label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" id="bank-corp-addr2">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 control-label">Телефон</label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" id="bank-corp-tel">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 control-label">Факс</label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" id="bank-corp-fax">
                                </div>
                            </div>
                        </form>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" id="bank-corp-make">Получить счет</button>
                        <button type="button" class="btn btn-default" data-dismiss="modal">Отмена</button>
                    </div>
                </div>
            </div>
        ...
        <div class="modal fade" role="dialog" id="modal-qiwi-tel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title">Введите номер телефона, зарегистрированного в системе QIWI</h4>
                    </div>
                    <div class="modal-body">
        ...
        <div class="modal fade" role="dialog" id="modal-ukr-card" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title">Оплата в Украине на карточку</h4>
                    </div>
                    <div class="modal-body">
                        <b>Ваша сумма для оплаты = <?= ceil($data['invoice']['amount'] / $data['currency']['UAH']); ?> гривен</b>
                        <br><br>
                        ...
                        <br><br>
                        Вы можете перевести деньги на номер карты, указанный выше, с карты любого банка Украины на этой странице:
                        <br>
                        <a href="https://www.ipay.ua/ua/p2p/ukrsibbank" target="_blank">https://www.ipay.ua/ua/p2p/ukrsibbank</a>
                        <br><br>
        ...
        <div id="payment-wizard">
            ...
            <?
            if (isset(APP::Module('Routing')->get['promo'])) {
                switch (APP::Module('Routing')->get['promo']) {
                    case 'ny':
                        ?>
                        <div id="gift-info" class="panel-body" style="background-image: url(<?= APP::Module('Routing')->root ?>public/ui/img/bg_payment.jpg); color: #FFFFFF;">
                           <img src="https://www.glamurnenko.ru/images/letter/ekaterina-150-1.png" style="float: left; width: 110px; margin-right: 25px;">
                           <div style="margin: 10px 0px; font-size: 19px;">
                               Еще у меня есть подарок за быструю оплату. 
                               Каждый день с момента оплаты и до вторника 19 декабря включительно, вы будете получать от меня новогодние сюрпризы ;) 
                               Чем позже оплата, тем меньше сюрпризов.
                           </div>
                       </div>
                        <?
                        break;
                    default: ?><hr class="mar-no"><? break;
                }
            } else {
                ?><hr class="mar-no"><?
            }
                            ...
                            <div class="col-md-8">
                                ...
                                <form id="invoice-details" class="form-horizontal" data-target="#payment-wizard-details">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">Фамилия</label>
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control" name="lastname" value="<?= isset($data['invoice_details']['lastname']) ? $data['invoice_details']['lastname'] : '' ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">Имя</label>
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control" name="firstname" value="<?= isset($data['invoice_details']['firstname']) ? $data['invoice_details']['firstname'] : '' ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">Телефон</label>
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control" name="tel" value="<?= isset($data['invoice_details']['tel']) ? $data['invoice_details']['tel'] : '' ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">E-Mail</label>
                                        <div class="col-lg-9">
                                            <input type="email" class="form-control" name="email" value="<?= isset($data['invoice_details']['email']) ? $data['invoice_details']['email'] : $data['invoice']['email'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">Комментарий к заказу</label>
                                        <div class="col-lg-9">
                                            <textarea rows="10" class="form-control" name="comment"><?= isset($data['invoice_details']['comment']) ? $data['invoice_details']['comment'] : '' ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-lg-offset-3 col-lg-9">
                                            <p style="font-size: 12px; color: #656565;">Нажимая на кнопку, я принимаю условия <a href="http://www.glamurnenko.ru/docs/agreement.html" target="_blank" style="font-size: 12px; color: #656565; text-decoration: underline;">договора оферты</a></p>
        ...
        $('#invoice-details').bootstrapValidator({
            ...
            onSuccess: function(e, data) {
                ...
                .submit(function() {
                    ...
                    $.ajax({
                        type: 'post',
                        url: '<?= APP::Module('Routing')->root; ?>billing/invoices/api/details/update.json',
        ...
        $('#bank-pp-make').click(function() {
            window.open('<?= APP::Module('Routing')->root ?>billing/payments/operators/bank/pp?invoice=<?= APP::Module('Crypt')->Encode($data['invoice']['id']) ?>&lastname=' + $('#bank-pp-lastname').val() + '&firstname=' + $('#bank-pp-firstname').val() + '&middlename=' + $('#bank-pp-middlename').val() + '&country=' + $('#bank-pp-country').val() + '&region=' + $('#bank-pp-region').val() + '&city=' + $('#bank-pp-city').val() + '&post-index=' + $('#bank-pp-post-index').val() + '&addr=' + $('#bank-pp-addr').val(), '_blank');
        });
        
        $('#bank-corp-make').click(function() {
            window.open('<?= APP::Module('Routing')->root ?>billing/payments/operators/bank/corp?invoice=<?= APP::Module('Crypt')->Encode($data['invoice']['id']) ?>&company=' + $('#bank-corp-company').val() + '&bank-details=' + $('#bank-corp-bank-details').val() + '&addr1=' + $('#bank-corp-addr1').val() + '&addr2=' + $('#bank-corp-addr2').val() + '&tel=' + $('#bank-corp-tel').val() + '&fax=' + $('#bank-corp-fax').val(), '_blank');
        });

        $('#set-qiwi-tel').click(function() {
            $('#modal-qiwi-tel').modal('hide');

            $.post('<?= APP::Module('Routing')->root ?>billing/payments/operators/qiwi/create-bill', {
                'tel': $('#qiwi-tel').val(),
                ...
                switch (ret.status) {
                    case 'success':
                        document.location.href = 'https://w.qiwi.com/order/external/main.action?shop=249687&transaction=' + ret.transaction + '&successUrl=<?= APP::Module('Routing')->root ?>billing/payments/success/<?= APP::Module('Routing')->get['invoice_id_hash'] ?>&failUrl=<?= APP::Module('Routing')->root ?>billing/payments/fail/<?= APP::Module('Routing')->get['invoice_id_hash'] ?>';
                        return false;
                        break;
                    case 'error':
                        switch (ret.info) {
