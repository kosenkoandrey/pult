                    ...
                    <div id="payment-wizard-finish" class="tab-pane mar-btm active">
                        <div class="eq-box-md text-center box-vmiddle-wrap">
                            <div class="box-vmiddle pad-all">
                                <h3 class="text-thin">ОПЛАТА НЕ ВЫПОЛНЕНА</h3>
                                <span class="icon-wrap icon-wrap-lg icon-circle bg-danger">
                                    <i class="fa fa-close fa-5x"></i>
                                </span>
                                <p>Мы не получили оплату за ваш заказ. Вернитесь к выбору способа оплаты и повторите попытку.</p>
                                <a class="btn btn-lg btn-danger btn-labeled fa fa-arrow-left" href="#" onclick="$('#payment-wizard').bootstrapWizard('first')">Выбрать другой способ оплаты</a>
                            </div>
                        </div>
                    </div>
                </div>
