...
<head>
    ...
    <title>Добавление типа продукта</title>
...
<body data-ma-header="teal">
    ...
    <section id="main">
        ...
        <section id="content">
            <div class="container">
                <div class="card">
                    <form id="add-product-type" class="form-horizontal" role="form">
    ...
    <script>
        $(document).ready(function() {
            $('#add-product-type').submit(function(event) {
                ...
                $.ajax({
                    type: 'post',
                    url: '<?= APP::Module('Routing')->root ?>admin/billing/products/types/api/add.json',
                    data: $(this).serialize(),
                    success: function(result) {
                        switch(result.status) {
                            case 'success':
                                swal({
                                    title: 'Готово',
                                    text: 'Тип продукта "' + name.val() + '" успешно добавлен',
                                    type: 'success',
                        ...
                        $('#add-product-type').find('[type="submit"]').html('Добавить').attr('disabled', false);
                    }
                });
            });
        });
