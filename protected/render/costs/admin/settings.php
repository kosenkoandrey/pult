    ...
    <body data-ma-header="teal">
                        ...
                        <form id="update-settings" class="form-horizontal" role="form">
                            ...
                            <div class="card-body card-padding">
                                <ul class="tab-nav m-b-15" role="tablist" data-tab-color="teal">
                                    ...
                                    <li role="presentation"><a href="#settings-google" role="tab" data-toggle="tab">Google AdWords</a></li>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane animated fadeIn" id="settings-google">
                                        <div class="form-group">
                                            <label for="module_costs_google_utm_source" class="col-sm-2 control-label">UTM-source</label>
                                            <div class="col-sm-3">
                                                <div class="fg-line">
                                                    <input type="text" class="form-control" name="module_costs_google_utm_source" id="module_costs_google_utm_source">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="module_costs_google_utm_medium" class="col-sm-2 control-label">UTM-medium</label>
                                            <div class="col-sm-3">
                                                <div class="fg-line">
                                                    <input type="text" class="form-control" name="module_costs_google_utm_medium" id="module_costs_google_utm_medium">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="module_costs_google_logging" class="col-sm-2 control-label">Логгирование</label>
                                            <div class="col-sm-1">
                                                <div class="toggle-switch m-t-10">
                                                    <input id="module_costs_google_logging" name="module_costs_google_logging" type="checkbox" hidden="hidden">
                                                    <label for="module_costs_google_logging" class="ts-helper"></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#module_costs_google_utm_source').val('<?= APP::Module('Costs')->settings['module_costs_google_utm_source'] ?>');
                $('#module_costs_google_utm_medium').val('<?= APP::Module('Costs')->settings['module_costs_google_utm_medium'] ?>');
                $('#module_costs_google_logging').prop('checked', <?= (int) APP::Module('Costs')->settings['module_costs_google_logging'] ?>);
                ...
                $('#update-settings').submit(function(event) {
                    ...
                    var module_costs_google_utm_source = $(this).find('#module_costs_google_utm_source');
                    var module_costs_google_utm_medium = $(this).find('#module_costs_google_utm_medium');
                    ...
                    module_costs_google_utm_source.closest('.form-group').removeClass('has-error has-feedback').find('.form-control-feedback, .help-block').remove();
                    module_costs_google_utm_medium.closest('.form-group').removeClass('has-error has-feedback').find('.form-control-feedback, .help-block').remove();
                    ...
                    if (module_costs_google_utm_source.val() === '') { module_costs_google_utm_source.closest('.form-group').addClass('has-error has-feedback').find('.col-sm-3').append('<span class="zmdi zmdi-close form-control-feedback"></span><small class="help-block">Not specified</small>'); return false; }
                    if (module_costs_google_utm_medium.val() === '') { module_costs_google_utm_medium.closest('.form-group').addClass('has-error has-feedback').find('.col-sm-3').append('<span class="zmdi zmdi-close form-control-feedback"></span><small class="help-block">Not specified</small>'); return false; }
