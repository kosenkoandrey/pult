<?
$filters = htmlspecialchars(isset(APP::Module('Routing')->get['filters']) ? APP::Module('Crypt')->Decode(APP::Module('Routing')->get['filters']) : '{"logic":"intersect","rules":[{"method":"utm_source","settings":{"logic":"LIKE","value":"%"}}]}');
?>
<!DOCTYPE html>
                            ...
                            <ul class="actions">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <li><a href="<?= APP::Module('Routing')->root ?>admin/costs/get">Получить расходы</a></li>
