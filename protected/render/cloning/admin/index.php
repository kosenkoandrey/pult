                        ...
                        <form id="cloning" class="form-horizontal" role="form">
                            ...
                            <div class="card-body card-padding">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select multiple id="profiles" name="profiles[]" class="selectpicker">
                                            <? foreach (APP::Module('Cloning')->conf['profiles'] as $key => $value) { ?><option value="<?= $key ?>" selected><?= $value['name'] ?></option><? } ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
