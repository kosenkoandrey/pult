...
<!--[if IE 9 ]><html class="ie9"><![endif]-->
    <head>
        ...
        <title>Ваша оценка принята. Оставьте комментарий.</title>
        ...
        <section id="main" class="center">
            <section id="content">
                <div class="container">
                    ...
                    <div id="main_cont" class="card" style="margin-bottom:0;">
                        <div class="card-header"><h2 style="line-height: 23px; !important">Ваша оценка принята. Оставьте комментарий.</h2></div>
                        <div class="card-body card-padding">
                            <form id="post-comment" method="post">
                                <input type="hidden" name="id" value="<?= $data ?>">
                                Как считаете, что мы можем сделать лучше?
                                <br><br>
                                <textarea rows="7" class="form-control" id="comment" name="comment" placeholder="Напишите Ваш комментарий" style="border: 1px solid #e3e3e3; padding: 10px;"></textarea>
                                <br>
                                <button type="submit" class="btn palette-Deep-Orange bg waves-effect btn-lg">Отправить</button>
                            </form>
                        </div>
                    </div>
                    <div class="card">
                ...
                $('#post-comment').submit(function(event) {
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            if (result) {
                                $('#main_cont h2').html('Спасибо за ваш комментарий');
                                $('#main_cont .card-body').remove();
                            }

                            $('#post-comment').find('[type="submit"]').html('Отправить').attr('disabled', false);
                        }
                    });
                });
            });
