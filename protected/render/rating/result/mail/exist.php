...
<!--[if IE 9 ]><html class="ie9"><![endif]-->
    <head>
        ...
        <title>Ваша оценка и комментарий были сохранены ранее</title>
            ...
            <section id="content">
                <div class="container">
                    ...
                    <div id="main_cont" class="card" style="margin-bottom:0;">
                        <div class="card-header"><h2 style="line-height: 23px; !important">Ваша оценка и комментарий были сохранены ранее</h2></div>
                    </div>
                    <div class="card">
