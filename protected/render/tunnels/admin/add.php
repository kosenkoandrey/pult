...
<!--[if IE 9 ]><html class="ie9"><![endif]-->
    <head>
        ...
        <title>Добавление туннеля</title>
                            ...
                            <div class="card-body card-padding">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-5">
                                        <button type="submit" class="btn palette-Teal bg waves-effect btn-lg">Добавить туннель</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                ...
                $('#add-tunnel').submit(function(event) {
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            ...
                            $('#add-tunnel').find('[type="submit"]').html('Добавить туннель').attr('disabled', false);
                        }
                    });
                  });
            });
