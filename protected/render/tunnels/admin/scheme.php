                            ...
                            .append(
                                ...
                                .append(
                                    ...
                                    .append(
                                        ...
                                        .on('click', function() {
                                            TunnelEditor.AddAction({
                                                tunnel_id: TunnelEditor.Tunnel.id,
                                                action: 'random_subscribe_tunnel',
                                                settings: {
                                                    processes: []
                                                },
                                                child_object: [],
                                ...
                                .append(
                                    ...
                                    .append(
                                        ...
                                        .append('Завершение текущего туннеля')
                                        .on('click', function() {
                                            TunnelEditor.AddAction({
                                                tunnel_id: TunnelEditor.Tunnel.id,
                                                action: 'complete_current_tunnel',
                                                settings: {},
                                                child_object: [],
                                                style: {
                                                    top: Math.ceil(($(window).scrollTop() + 10) / 10) * 10,
                    ...
                    switch (type) {
                        case 'action':
                            var action_icons = {
                                ...
                                'subscribe_tunnel': 'glyphicon-check',
                                'random_subscribe_tunnel': 'glyphicon-random',
                                'complete_tunnel': 'glyphicon-ok-circle',
                                'set_user_tag': 'glyphicon-tag',
                                'resume_tunnel': 'glyphicon-play-circle',
                                'recycle_tunnel': 'glyphicon-repeat',
                                'complete_current_tunnel': 'glyphicon-off'
                            };
                            ...
                            case 'action':
                                switch (TunnelEditor.Objects.Actions[id].action) {
                                    ...
                                    case 'random_subscribe_tunnel':
                                        var random_subscribe_tunnel_count = TunnelEditor.Objects.Actions[id].settings.tunnels.length;
                                        ...
                                        .append(
                                            ...
                                            .on('click', function() {
                                                $('#object-tunnels-list').append([
                                                    '<div class="panel panel-default" style="margin: 0 0 10px 0;">',
                                                        '<div class="panel-heading" role="tab">',
                                                            '<h4 class="panel-title" id="object-tunnels-list-title-' + random_subscribe_tunnel_count + '">',
                                                                '<a data-parent="#object-tunnels-list" data-toggle="collapse" href="#object-tunnels-list-settings-' + random_subscribe_tunnel_count + '">Туннель</a>',
                                                            '</h4>',
                                                        '</div>',
                                                        '<div class="panel-collapse collapse" id="object-tunnels-list-settings-' + random_subscribe_tunnel_count + '" role="tabpanel">',
                                                            '<div class="panel-body"></div>',
                                                        '</div>',
                                                    '</div>',
                                                ].join(''));

                                                $('#object-tunnels-list-title-' + random_subscribe_tunnel_count)
                                                .append(
                                                    $('<button/>', {
                                                        type: 'button',
                                                ...
                                                $('#object-tunnels-list-settings-' + random_subscribe_tunnel_count + ' > .panel-body')
                                                .append(
                                                    $('<div/>', {
                                                        class: 'form-group'
                                                    })
                                                    .append(
                                                        $('<label/>', {
                                                            for: 'tunnel_id_' + random_subscribe_tunnel_count,
                                                            class: 'col-sm-2 control-label'
                                                        })
                                                        .append('Туннель')
                                                    )
                                                    .append(
                                                        ...
                                                        .append(
                                                            $('<input/>', {
                                                                type: 'hidden',
                                                                class: 'form-control',
                                                                id: 'tunnel_id_' + random_subscribe_tunnel_count
                                                            })
                                                        )
                                                    )
                                                )
                                                .append(
                                                    ...
                                                    .append(
                                                        $('<label/>', {
                                                            for: 'in_process_1_' + random_subscribe_tunnel_count,
                                                            class: 'col-sm-2 control-label'
                                                        })
                                                        .append('Тип объекта')
                                                    )
                                                    .append(
                                                        ...
                                                        .append(
                                                            $('<select/>', {
                                                                class: 'form-control',
                                                                id: 'in_process_1_' + random_subscribe_tunnel_count
                                                            })
                                                            .append(
                                                                $('<option/>', {
                                                                    value: 'actions'
                                                ...
                                                .append(
                                                    ...
                                                    .append(
                                                        $('<label/>', {
                                                            for: 'in_process_2_' + random_subscribe_tunnel_count,
                                                            class: 'col-sm-2 control-label'
                                                        })
                                                        .append('Объект')
                                                    )
                                                    .append(
                                                        ...
                                                        .append(
                                                            $('<input/>', {
                                                                type: 'text',
                                                                class: 'form-control',
                                                                id: 'in_process_2_' + random_subscribe_tunnel_count
                                                            })
                                                        )
                                                    )
                                                )
                                                .append(
                                                    ...
                                                    .append(
                                                        $('<label/>', {
                                                            for: 'in_activation_letter_' + random_subscribe_tunnel_count,
                                                            class: 'col-sm-2 control-label'
                                                        })
                                                        .append('Письмо активации')
                                                    )
                                                    .append(
                                                        ...
                                                        .append(
                                                            $('<input/>', {
                                                                type: 'hidden',
                                                                class: 'form-control',
                                                                id: 'in_activation_letter_' + random_subscribe_tunnel_count
                                                            })
                                                        )
                                                    )
                                                )
                                                .append(
                                                    ...
                                                    .append(
                                                        $('<label/>', {
                                                            for: 'activation_url_' + random_subscribe_tunnel_count,
                                                            class: 'col-sm-2 control-label'
                                                        })
                                                        .append('URL активации')
                                                    )
                                                    .append(
                                                        ...
                                                        .append(
                                                            $('<input/>', {
                                                                type: 'text',
                                                                class: 'form-control',
                                                                id: 'in_activation_url_' + random_subscribe_tunnel_count
                                                            })
                                                        )
                                                    )
                                                )
                                                ...
                                                .append(
                                                    ...
                                                    .append(
                                                        $('<label/>', {
                                                            for: 'in_permanent_pause_processes_' + random_subscribe_tunnel_count,
                                                            class: 'col-sm-2 control-label'
                                                        })
                                                        .css({
                                                            'padding-top': '0'
                                                    ...
                                                    .append(
                                                        ...
                                                        .append(
                                                            $('<input/>', {
                                                                type: 'text',
                                                                class: 'form-control',
                                                                id: 'in_permanent_pause_processes_' + random_subscribe_tunnel_count
                                                            })
                                                        )
                                                    )
                                                );
                                                */
                                                ...
                                                $('#in_activation_letter_' + random_subscribe_tunnel_count).MailingLetterSelector();
                                        
                                                ++ random_subscribe_tunnel_count;
                                            })
                                        )
                                        .append(
                                            $('<div/>', {
                                        ...
                                        .on('submit', function(e) {
                                            var tunnels_objects = new Array();
                                            
                                            for (var i = 0; i <= random_subscribe_tunnel_count; i++) {
                                                if ($('#object-tunnels-list-settings-' + i).length) {
                                                    tunnels_objects.push({
                                            ...
                                            TunnelEditor.Objects.Actions[id].settings.tunnels = tunnels_objects;
                            ...
                            case 'action':
                                switch (TunnelEditor.Objects.Actions[id].action) {
                                    ...
                                    case 'subscribe_tunnel':
                                        ...
                                        break;
                                    case 'random_subscribe_tunnel': 
                                        $.each(TunnelEditor.Objects.Actions[id].settings.tunnels, function(i, tunnel) {
                                            $('#object-tunnels-list').append([
                                                '<div class="panel panel-default" style="margin: 0 0 10px 0;">',
                                                    '<div class="panel-heading" role="tab">',
                                                        '<h4 class="panel-title" id="object-tunnels-list-title-' + i + '">',
                                                            '<a data-parent="#object-tunnels-list" data-toggle="collapse" href="#object-tunnels-list-settings-' + i + '">Туннель</a>',
                                                        '</h4>',
                                                    '</div>',
                                                    '<div class="panel-collapse collapse" id="object-tunnels-list-settings-' + i + '" role="tabpanel">',
                                                        '<div class="panel-body"></div>',
                                                    '</div>',
                                                '</div>',
                                            ].join(''));
                                            
                                            $('#object-tunnels-list-title-' + i)
                                            .append(
                                                $('<button/>', {
                                                    type: 'button',
                                                    class: 'btn btn-danger btn-xs pull-right'
                                            ...
                                            $('#object-tunnels-list-settings-' + i + ' > .panel-body')
                                            .append(
                                                $('<div/>', {
                                                    class: 'form-group'
                                                })
                ...
                updateActionDetails: function(id, object) {
                    ...
                    switch (action_type) {
                        ...
                        case 'random_subscribe_tunnel':
                            ...
                            $.each(action.settings.tunnels, function (i, item) {
                        ...
                        case 'resume_tunnel':
                            if (action.settings.tunnel_id) {
                                action_details = 'Снятие туннеля с паузы<br>"' + TunnelEditor.getTunnelNameById(action.settings.tunnel_id) + '"';
                                object.find('.action_details').html(action_details);
                                action.textDescription = action_details;
                            }
                            break;
                        case 'recycle_tunnel':
                            ...
                            break;
                        case 'complete_current_tunnel':
                            object.find('.action_details').html('Завершение текущего туннеля');
                            action.textDescription = 'Завершение текущего туннеля';
                            break;
                    }
                },
