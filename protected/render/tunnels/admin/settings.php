...
<!--[if IE 9 ]><html class="ie9"><![endif]-->
    <head>
        ...
        <title>Настройки туннелей</title>
    ...
    <body data-ma-header="teal">
        ...
        APP::Render('admin/widgets/header', 'include', [
            'Туннели' => 'admin/tunnels/settings'
        ]);
        ?>
        <section id="main">
                    ...
                    <div class="card">
                        <form id="update-settings" class="form-horizontal" role="form">
                            <div class="card-header">
                                <h2>Настройки туннелей</h2>
                            </div>

                            <div class="card-body card-padding">
                                <div class="form-group">
                                    <label for="module_tunnels_db_connection" class="col-sm-2 control-label">Соединение с БД</label>
                                    <div class="col-sm-2">
                                        <div class="fg-line">
                                ...
                                <div class="form-group">
                                    <label for="module_tunnels_max_execution_time" class="col-sm-2 control-label">Макс. время выполнения обработчика туннелей (сек)</label>
                                    <div class="col-sm-2">
                                        <div class="fg-line">
                                ...
                                <div class="form-group">
                                    <label for="module_tunnels_execution_tunnels_number" class="col-sm-2 control-label">Макс. кол-во туннелей в цикле обработке</label>
                                    <div class="col-sm-2">
                                        <div class="fg-line">
                                ...
                                <div class="form-group">
                                    <label for="module_tunnels_active_user_roles" class="col-sm-2 control-label">Запускать туннели для пользовательских ролей</label>
                                    <div class="col-sm-4">
                                        <select id="module_tunnels_active_user_roles" name="module_tunnels_active_user_roles[]" multiple data-placeholder="Выберите роли...">
                                            <?
                                ...
                                <div class="form-group">
                                    <label for="module_tunnels_max_run_timeout" class="col-sm-2 control-label">Макс. время таймаута при подписке (сек)</label>
                                    <div class="col-sm-2">
                                        <div class="fg-line">
                                ...
                                <div class="form-group">
                                    <label for="module_tunnels_default_queue_timeout" class="col-sm-2 control-label">Стандартный таймаут для туннелей в очереди (сек)</label>
                                    <div class="col-sm-2">
                                        <div class="fg-line">
                                ...
                                <div class="form-group">
                                    <label for="module_tunnels_max_queue_timeout" class="col-sm-2 control-label">Макс. время таймаута для туннелей в очереди (сек)</label>
                                    <div class="col-sm-2">
                                        <div class="fg-line">
                                ...
                                <div class="form-group">
                                    <label for="module_tunnels_indoctrination_lifetime" class="col-sm-2 control-label">Сол-во секунд после регистрации пользователя для запуска индоктринации</label>
                                    <div class="col-sm-2">
                                        <div class="fg-line">
                                ...
                                <div class="form-group">
                                    <label for="module_tunnels_resend_acrivation_timeout" class="col-sm-2 control-label">Таймаут повторной отправки письма активации при подписке (сек)</label>
                                    <div class="col-sm-2">
                                        <div class="fg-line">
                                ...
                                <div class="form-group">
                                    <label for="module_tunnels_memory_limit" class="col-sm-2 control-label">Лимит памяти для обработчика туннелей</label>
                                    <div class="col-sm-2">
                                        <div class="fg-line">
                                ...
                                <div class="form-group">
                                    <label for="module_tunnels_tmp_dir" class="col-sm-2 control-label">Временная директория</label>
                                    <div class="col-sm-2">
                                        <div class="fg-line">
                        ...
                        success: function(result) {
                            switch(result.status) {
                                case 'success':
                                    swal({
                                        title: 'Готово',
                                        text: 'Настройки туннелей были обновлены',
                                        type: 'success',
