                    ...
                    <div class="card">
                            ...
                            <ul class="actions">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <li><a href="<?= APP::Module('Routing')->root ?>admin/tunnels/settings">Настройки</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="card-body">
                            <table class="table table-hover table-vmiddle" id="tunnels-table">
                                <thead>
                                    <tr>
                                        <th data-column-id="id" data-type="numeric" data-order="desc" data-header-css-class="tunnels-column-id">ID</th>
                                        <th data-column-id="type" data-formatter="type" data-header-css-class="tunnels-column-type">Тип</th>
                                        <th data-column-id="state" data-formatter="state" data-header-css-class="tunnels-column-state">Состояние</th>
                                        <th data-column-id="name" data-sortable="false">Наименование</th>
                                        <th data-column-id="description" data-sortable="false" data-visible="false">Описание</th>
                                        <th data-column-id="actions" data-formatter="actions" data-sortable="false" data-header-css-class="tunnels-column-actions">Действия</th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
                ...
                var tunnels_table = $("#tunnels-table").bootgrid({
                    ...
                    formatters: {
                        type: function(column, row) {
                            switch (row.type) {
                                case 'static': return 'статический'; break;
                                case 'dynamic': return 'динамический'; break;
                            }
                        },
                        ...
                        actions: function(column, row) {
                            return  '<a target="_blank" href="<?= APP::Module('Routing')->root ?>admin/tunnels/smartlog/' + row.tunnel_id_token + '" class="btn btn-sm btn-default btn-icon waves-effect waves-circle"><span class="zmdi zmdi-eye"></span></a> ' + 
                                    '<a target="_blank" href="<?= APP::Module('Routing')->root ?>admin/tunnels/edit/' + row.tunnel_id_token + '" class="btn btn-sm btn-default btn-icon waves-effect waves-circle"><span class="zmdi zmdi-edit"></span></a> ' + 
