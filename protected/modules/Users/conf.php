...
return [
    'routes' => [
        ...
        ['users\/api\/add\.json(\?.*)?',                                        'Users', 'APIAddUser'],                 // [API] Add user
        ...
        ['users\/api\/utm\/add\.json(\?.*)?',                                   'Users', 'APIAddUTM'],                  // [API] Add user UTM labels
        ...
        ['users\/api\/about\/update\/item\.json(\?.*)?',                        'Users', 'APIUpdateAboutItem'],         // [API] Update about item any user
        ...
        ['admin\/users\/export\/excel(\?.*)?',                                  'Users', 'ExportUsersExcel'],           // Export users to Excel
        ...
        ['admin\/users\/api\/about\/sources\/list\.json(\?.*)?',                'Users', 'APIAdminAboutSourcesList'],       // [API] About sources list
        ['admin\/users\/api\/email\/alt\/add\.json(\?.*)?',                     'Users', 'APIAddAltEmail'],                 // [API] Add alt email
        ['admin\/users\/api\/email\/alt\/remove\.json(\?.*)?',                  'Users', 'APIRemoveAltEmail'],              // [API] Add alt email
        ['admin\/users\/api\/email\/change\/check\.json(\?.*)?',                'Users', 'APICheckChangeEMail'],            // [API] Check change user E-Mail
        ['admin\/users\/api\/email\/change\.json(\?.*)?',                       'Users', 'APIChangeEMail'],                 // [API] Change user E-Mail
        ['admin\/users\/api\/email\/change\/combine\.json(\?.*)?',              'Users', 'APICombineEMail'],                // [API] Combine user E-Mail
    ],
    'init' => true
];