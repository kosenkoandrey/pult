...
return [
    'routes'  => [
        ...
        ['files\/open\/(?P<download_id_hash>.*)',                                               'Files', 'OpenFile'], // Open file
        ...
        ['admin\/files\/check\/mp4(\?.*)?',                                                     'Files', 'CheckMP4File'], // Check MP4 file
        ...
        ['admin\/files\/api\/file\/check\/mp4\.json(\?.*)?',                                    'Files', 'APICheckMP4File'], // [API] Check MP4 file
