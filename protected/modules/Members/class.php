...
class Members {
    ...
    public function ManageUserPages() {
        ...
        foreach (APP::Module('DB')->Select(
            ...
            [['user_id', '=', APP::Module('Users')->user['id'], PDO::PARAM_INT]]
        ) as $value) {
            $user_access[$value['item']][] = $value['item_id'];
        }
        ...
        foreach (APP::Module('DB')->Select(
            ...
            if (array_search($value['id'], $user_access['g']) !== false) {
                $list[] = ['group', $value['id'], $value['name']];
            }
        }
        ...
        foreach (APP::Module('DB')->Select(
            ...
            if (array_search($value['id'], $user_access['p']) !== false) {
                $list[] = ['page', $value['id'], $value['title']];
            }
        }
