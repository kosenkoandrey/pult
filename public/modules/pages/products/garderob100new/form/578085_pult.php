...
<form style="margin: 0; padding: 0;" name="SR_form" target="_parent" action="http://pult.glamurnenko.ru/Tunnel/External" method="get" onSubmit="return SR_submit(this)">
                            <input id="tid" name="tid" type="hidden" value="g100"/>
                            <input id="gid" name="gid" type="hidden" value="3s"/>
                            <input id="aid" name="aid" type="hidden" value="success"/>
          <div ql-id="optin_email" class="group">
            <input type="text" value="<?=$_GET['tr_e']?>" name="email" id="field_email" readonly="false"><p class="optin-error"></p>
                            <input id="return" name="return" type="hidden" value="http://www.glamurnenko.ru/garderob100/activate/wait-list-final.php"/>
          </div>
          <button ql-id="call_to_action_button" ql-name="Call To Action Button" ql-editable="button" type="submit" class="btn">Получить видео<br></button>
        </form>
