...
(function($) {
    var methods = {
        ...
        getRulesListByLogic: function(logic) {
            return [
                '<li><a class="add_trigger_rule" data-logic="' + logic + '" data-method="item" href="javascript:void(0)">Тип объекта</a></li>',
                '<li><a class="add_trigger_rule" data-logic="' + logic + '" data-method="object" href="javascript:void(0)">ID объекта</a></li>',
                '<li><a class="add_trigger_rule" data-logic="' + logic + '" data-method="rating" href="javascript:void(0)">Оценка</a></li>',
                '<li><a class="add_trigger_rule" data-logic="' + logic + '" data-method="user" href="javascript:void(0)">Пользователь</a></li>',
                '<li><a class="add_trigger_rule" data-logic="' + logic + '" data-method="comment" href="javascript:void(0)">Комментарий</a></li>'
            ].join('');
        },
                                ...
                                '<td style="width: 270px">',
                                    '<select class="selectpicker" data-id="logic">',
                                        ...
                                        '<optgroup label="по маске">',
                                            '<option value="LIKE">соответствует маске</option>',
                                            '<option value="NOT LIKE">не соответствует маске</option>',
                                        '</optgroup>',
                                        '<optgroup label="регулярное выражение">',
                                            '<option value="REGEXP">соответствует рег. выражению</option>',
                                            '<option value="NOT REGEXP">не соответствует рег. выражению</option>',
                                        '</optgroup>',
                                    '</select>',
                                '</td>',
                                '<td style="width: 270px">',
