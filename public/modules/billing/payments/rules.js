    ...
    var methods = {
        ...
        getRulesListByLogic: function(logic) {
            return [
                ...
                '<li><a class="add_trigger_rule" data-logic="' + logic + '" data-method="invoice" href="javascript:void(0)">Счет</a></li>',
                '<li><a class="add_trigger_rule" data-logic="' + logic + '" data-method="method" href="javascript:void(0)">Оператор</a></li>',
                '<li><a class="add_trigger_rule" data-logic="' + logic + '" data-method="user" href="javascript:void(0)">Пользователь</a></li>',
                '<li><a class="add_trigger_rule" data-logic="' + logic + '" data-method="cr_date" href="javascript:void(0)">Дата платежа</a></li>',
            ].join('');
        },
