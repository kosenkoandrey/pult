    ...
    var methods = {
        ...
        getRulesListByLogic: function(logic) {
            return [
                ...
                '<li><a class="add_trigger_rule" data-logic="' + logic + '" data-method="name" href="javascript:void(0)">Наименование</a></li>',
                '<li><a class="add_trigger_rule" data-logic="' + logic + '" data-method="amount" href="javascript:void(0)">Цена</a></li>'
            ].join('');
        },
