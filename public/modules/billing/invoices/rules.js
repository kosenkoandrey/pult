    ...
    var methods = {
                            ...
                            switch(method) {
                                ...
                                case 'cr_date': 
                                    switch(id) {
                                        ...
                                        case 'date_to': 
                                            ...
                                            settings.date_to = Math.round(objects['cr_date_to'].date._d.setHours(23, 59, 59, 999) / 1000); 
                                            break;
                                        default: settings[id] = param_value;
                                    }
                                    break;
                                case 'pay_date': 
                                    switch(id) {
                                        case 'date_from': 
                                            if (settings.date_from === undefined) settings.date_from = new Object();
                                            settings.date_from = Math.round(objects['pay_date_from'].date._d.setHours(0, 0, 0, 0) / 1000); 
                                            break;
                                        case 'date_to': 
                                            if (settings.date_to === undefined) settings.date_to = new Object();
                                            settings.date_to = Math.round(objects['pay_date_to'].date._d.setHours(23, 59, 59, 999) / 1000); 
                                            break;
                                        default: settings[id] = param_value;
                                    }
                                    break;
        ...
        getRulesListByLogic: function(logic) {
            return [
                ...
                '<li><a class="add_trigger_rule" data-logic="' + logic + '" data-method="author_comment" href="javascript:void(0)">Автор комментария</a></li>',
                ...
                '<li><a class="add_trigger_rule" data-logic="' + logic + '" data-method="pay_date" href="javascript:void(0)">Дата оплаты</a></li>',
                '<li><a class="add_trigger_rule" data-logic="' + logic + '" data-method="label" href="javascript:void(0)">Метка</a></li>',
            ].join('');
        },
        ...
        render_rule: function(rule, holder) {
            ...
            switch(rule.method) {
                ...
                case 'cr_date':
                    ...
                    //if (rule.settings.date_from !== undefined) $('.trigger_settings select[data-id="date_from"]', $trigger_rule_item).val(rule.settings.date_from);
                    ...
                    //if (rule.settings.date_to !== undefined) $('.trigger_settings select[data-id="date_to"]', $trigger_rule_item).val(rule.settings.date_to);
