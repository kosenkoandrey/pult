...
class APP {
    ...
    public static function Init($conf, $argv) {
        ...
        require ROOT . '/protected/vendor/autoload.php';
    ...
    public static function ErrorHandler($errno, $errstr, $errfile, $errline, $errcontext) {
        if (error_reporting()) self::Logging('php-errors', 'core/error', 0, [$errno, $errstr, $errfile, $errline, $errcontext, debug_backtrace()]);
    }
